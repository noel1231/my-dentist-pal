...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        var __SCOLLEVENTTEMP = "<DIV style=\"WIDTH:${width};top:${top};left:${left};\" title=\"${title}\" class=\"chip chip${i} ${drag}\"><div class=\"dhdV\" style=\"display:none\">${data}</div><DIV style=\"BORDER-BOTTOM-COLOR:#6495ED;\" class=ct>&nbsp;</DIV><DL style=\"BORDER-BOTTOM-COLOR:#6495ED; BACKGROUND-COLOR:#6495ED; BORDER-TOP-COLOR: #6495ED; HEIGHT: ${height}px; BORDER-RIGHT-COLOR:#6495ED; BORDER-LEFT-COLOR:#6495ED\"><DT style=\"BACKGROUND-COLOR:#6495ED;FONT-SIZE:12px;\">${starttime} - ${endtime} ${icon}</DT><DD><SPAN style=\"FONT-SIZE:14px;\">${content}</SPAN></DD><DIV class='resizer' style='display:${redisplay}'><DIV class=rszr_icon>&nbsp;</DIV></DIV></DL><DIV style=\"BORDER-BOTTOM-COLOR:#6495ED; BACKGROUND-COLOR:#6495ED; BORDER-TOP-COLOR: #6495ED; BORDER-RIGHT-COLOR: #6495ED; BORDER-LEFT-COLOR:#6495ED;\" class=cb1>&nbsp;</DIV><DIV style=\"BORDER-BOTTOM-COLOR:#6495ED; BORDER-TOP-COLOR:#6495ED; BORDER-RIGHT-COLOR:#6495ED; BORDER-LEFT-COLOR:#6495ED;\" class=cb2>&nbsp;</DIV></DIV>";
        var __ALLDAYEVENTTEMP = '<div class="rb-o ${eclass}" id="${id}" title="${title}" style="color:#6495ED;"><div class="dhdV" style="display:none">${data}</div><div class="${extendClass} rb-m" style="background-color:#6495ED;">${extendHTML}<div class="rb-i" style="font-size:14px;height:18px;">${content}</div></div></div>';
        ...
        function dayshow(e, data) {
            ...
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
                    var csbuddle = '<div id="bbit-cs-buddle" style="z-index: 180; width: 400px;visibility:hidden;" class="bubble"><table class="bubble-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="bubble-cell-side"><div id="tl1" class="bubble-corner"><div class="bubble-sprite bubble-tl"></div></div><td class="bubble-cell-main"><div class="bubble-top"></div><td class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root"><table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><div id="bbit-cs-what" style="font-size:16px;" title="'
                    	+ i18n.xgcalendar.click_to_detail + '" class="textbox-fill-div lk" style="cursor:pointer;"></div></div></div></td></tr><tr><td class=cb-value><div id="bbit-cs-buddle-timeshow" style="font-size:16px;"></div></td></tr></tbody></table><div class="bbit-cs-split"><input id="bbit-cs-id" type="hidden" value=""/>[ <span id="bbit-cs-delete" class="lk" style="font-size:16px;">'
                    	+ i18n.xgcalendar.i_delete + '</span> ]&nbsp; <SPAN id="bbit-cs-editLink" class="lk" style="font-size:16px;">'
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            if (buddle.length == 0) {
                ...
                temparr.push('<table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr><th class="cb-key" style="font-size:16px;">');
                temparr.push(i18n.xgcalendar.time, ':</th><td class=cb-value><div id="bbit-cal-buddle-timeshow" style="font-size:16px;"></div></td></tr><tr><th class="cb-key" style="font-size:16px;">');
                temparr.push(i18n.xgcalendar.content, ':</th><td class="cb-value" style="font-size:16px;"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><input id="bbit-cal-what" class="textbox-fill-input" style="font-size:16px;"/></div></div><div class="cb-example">');
                ...
                temparr.push(i18n.xgcalendar.create_event, '" type="button" style="font-size:16px;"/>&nbsp; <SPAN id="bbit-cal-editLink" class="lk" style="font-size:16px;">');
