...
<table cellpadding="0" cellspacing="0" border="0" id="print_this"><tr><td>
 <!--date holder-->
	...
	{ $back="#e0eefa";}
           ...
           <td width="90" style="font-family:Arial, Helvetica, sans-serif;color:#7a7d7f;font-size:15px;text-align:center;padding-top:8px;padding-bottom:5px;"> 
           <?php echo $row['log_date'];?>
           </td>
            <td width="88" style="font-family:Arial, Helvetica, sans-serif;color:#7a7d7f;font-size:15px;text-align:center;padding-top:8px;padding-bottom:5px;"> 
          <?php echo $row['tooth_num'];?>
           </td>
            <td width="92" style="font-family:Arial, Helvetica, sans-serif;color:#7a7d7f;font-size:15px;text-align:center;padding-top:8px;padding-bottom:5px;"> 
          <?php echo $row['surface'];?>
           </td>
            <td width="188" style="font-family:Arial, Helvetica, sans-serif;color:#7a7d7f;font-size:15px;text-align:center;padding-top:8px;padding-bottom:5px;"> 
          <?php echo $row['treatment_notes'];?>
           </td>
            <td width="78" style="font-family:Arial, Helvetica, sans-serif;color:#7a7d7f;font-size:15px;text-align:right;padding-right:6px;padding-top:8px;padding-bottom:5px;"> 
           P&nbsp;<?php echo $row['intial'];?>&nbsp;.00
           </td>
           <td width="69" style="font-family:Arial, Helvetica, sans-serif;color:#7a7d7f;font-size:15px;text-align:right;padding-right:6px;padding-top:8px;padding-bottom:5px;"> 
