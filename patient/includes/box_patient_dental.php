         ...
         <!--<div style="width:130px; margin-left:10px; margin-bottom:-2px; float:left; z-index:999999999">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="661" align="center" style="background: url(img/u3.jpg); font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#3e4447;"><!--Joselito Galvez-->
                <?php
				/*
				$length=14;
$name1=$name;
...
echo "<span style=\"margin-left:4px;color:#333;font-family:Arial, Helvetica, sans-serif;font-size:14px;\">$display</span>";
echo "..." ;
      ...
      <tr>
        <td colspan="2" valign="top" style="background:url(../img/3.jpg); padding-bottom:10px;"><div style="margin-top:-8px; position: relative;">
          <table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <!--locations-->
                ...
                Medical History
                 ...
                 <td style="background-color:#FFF;width:165px;height:36px;text-align:center;"> 
              ...
              <a href="patient_dental_edit.php" style="color:#FFF;font-family:Arial, Helvetica, sans-serif;font-weight:bold;font-size:14px;text-decoration:none;">
               Edit
                </a>
                </td>-->
            ...
            <div style="background-color:#FFF;padding-left:15px;padding-top:25px;padding-right:80px;">
            <table cellpadding="0" cellspacing="0" border="0" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;width:100%;">
...
<td valign="top" style="padding-left:20px;" align="right">
<table cellpadding="0" cellspacing="0" border="0">
