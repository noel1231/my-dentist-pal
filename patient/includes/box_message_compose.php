        ...
        <td colspan="2" valign="top" style="background:url(../img/3.jpg); padding-bottom:10px;"><div style="margin-top:-8px; position: relative;">
          <table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td style="padding-left:10px;"><input type="text" name="to" id="to" style="width:460px;font-size:15px;" value="<?php echo $email;?>"/></td>
             ...
             <!-- <tr><td style="text-align:right;">
              ...
              <td style="padding-left:10px;"><input type="text" name="subject" style="width:460px;font-size:15px;"/></td>
