...
$s=mysql_query("SELECT * FROM promo_takers WHERE promo_id='".$idy."'");
...
//var_dump($to);var_dump($subject);var_dump($msg);var_dump($headers);
...
$sql1="SELECT * FROM promos_and_offer WHERE id='".$idy."'";
...
<?php } else { ?>
<span style="font-size:12px;color:#F00;"><i><?php echo $error;?></i></span>
<?php } ?>
</td>
