...
?>
<table cellpadding="0" cellspacing="0" border="0">
<tr><td style="text-align:left;" width="270">
<span style="font-size:15px;color:#333;font-family:Arial, Helvetica, sans-serif;">Unpaid Services</span>
</td>
<td style="width:30px;text-align:right;"><a href="patient_notes.php" style="text-decoration:none;" target="_blank"><span style="font-size:14px;color:#F00;"><?php echo $unpaid;?></span></a></td>
</tr>
...
?>
<td style="width:30px;text-align:right;"><span><a href="patient/promos_and_offer.php" style="text-decoration:none;font-size:14px;color:#F00;" target="_blank"><?php echo $rows;?></a></span></td>
</tr>
<tr><td colspan="2" style="border-bottom:1px #333 dotted;width:100%;padding-top:10px;"></td></tr>
...
//var_dump($rows);die();
?>
<td style="width:30px;text-align:right;"><span><a href="patient/message_received.php" style="font-size:14px;color:#F00;font-family: Arial, Helvetica, sans-serif;text-decoration:none;" target="_blank"><?php echo $rows;?></a></span></td>
</tr>
<tr><td colspan="2" style="border-bottom:1px #333 dotted;width:100%;padding-top:10px;"></td></tr>
...
<span style="font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif;color:#FFF;font-size:20px;">Info Bites</span>
...
<!--second- part content-->
<tr>
<!--firstbox--><td style="padding-top:20px;" colspan="2" valign="top">
...
<span style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;color:#FFF;font-size:20px;">News And Announcements</span>
...
<!--sponsored section-->
<td style="padding-left:10px;padding-top:20px;" align="center" valign="top">
<?php 
$var="yes";
$type="side";
$ctr1=1;
...
<table cellpadding="0" cellspacing="0" border="0">
<tr><td>
<a href="<?php echo $ban_link1;?>"><img src="../admin/<?php echo $banner_top_left;?>" width="174" height="154"/></a>
</td>
<td style="padding-left:10px;">
<a href="<?php echo $ban_link2;?>"><img src="../admin/<?php echo $banner_top_right;?>" width="174" height="154"/></a>
</td>
</tr>
<tr><td style="padding-top:10px;">
<a href="<?php echo $ban_link3;?>"><img src="../admin/<?php echo $banner_bottom_left;?>" width="174" height="154"/></a>
</td>
<td style="padding-top:10px;padding-left:10px;">
<a href="<?php echo $ban_link4;?>"><img src="../admin/<?php echo $banner_bottom_right;?>" width="174" height="154"/></a>
</td>
</tr>
</table>
