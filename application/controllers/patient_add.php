...
class Patient_add extends CI_Controller {
	...
	function submit_patient()
	{
		...
		$data_medical_history = array(
			...
			'patient_name'=> $this->input->post('patient_fname'),
			'patient_middle_name'=> $this->input->post('patient_mname'),
			'patient_surname'=> $this->input->post('patient_lname'),
			...
			'patient_phone'=> $this->input->post('patient_homeNum'),
			'occupation_phone'=> $this->input->post('patient_officeName'),
