...
$sql=mysql_query("SELECT * FROM dentist_list WHERE email='".$username."'");
//
...
$msg .="<tr><td>";
$msg .="<h2 style=\"font-size:16px;font-family:Arial;color:#333;\">Good day &nbsp;".$text."&nbsp;".$lname.", ".$fname."</h2>";
$msg .="</td></tr>";
$msg .="<tr><td style=\"padding-top:20px;padding-left:10px;\">";
$msg .= "<a href=\"http://www.mydentistpal.com/reset.php?key=".$confirm."\">Click here to reset your password.</a>";
$msg .="</td></tr>";
$msg .="</table>";
$msg .="</body>";
$msg .="</html>";
...
$x=mysql_query("UPDATE dentist_list SET forgot_key='".$confirm."' WHERE id='".$id."'");
//$s = mysql_query($x);
//echo mysql_error();
