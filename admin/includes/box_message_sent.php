 ...
 if(isset($_POST['reply']))
{
	...
	if(count($_POST["check"]) >= 2) {
		...
		if($_POST["check"][$i] != "") {
			$qwerty="SELECT * FROM admin_sent_message WHERE id='".$_POST['check'][$i]."'";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
        ...
        <td colspan="2" valign="top" style="background:url(../img/3.jpg); padding-bottom:10px;"><div style="margin-top:-8px; position: relative;">
          <table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <!--<input type="button" onclick="window.location='message_compose.php'" name="compose" value="Compose Message" class="submit2"/>-->
              ...
              <div style="float:left;background-image:url(../img/option_name_repeat.png);width:189px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;"><a href="message_sent.php?arr=dentist_name" style="text-decoration:underline;color:#333;" title="Sort by Name">To</a></div>
              <div style="float:left;background-image:url(../img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--name holder-->
              ...
              <!--subject holder-->
              <div style="float:left;">
              <div style="float:left;background-image:url(../img/option_name_repeat.png);width:190px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;"><a href="message_sent.php?arr=message_subject" style="text-decoration:underline;color:#333;" title="Sort by Subject">Subject</a></div>
              <div style="float:left;background-image:url(../img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--subject holder-->
              ...
              <!--last visit-->
              <div style="float:left;">
              <div style="float:left;background-image:url(../img/option_name_repeat.png);width:185px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;"><a href="message_sent.php?arr=message_date" style="text-decoration:underline;color:#333;" title="Sort by Date">Date</a></div>
              <div style="float:left;background-image:url(../img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--last visit-->
    	...
    	$startpoint = ($page * $limit) - $limit;
		 //$statement = "`records` where `active` = 1";
			  ...
			  if(isset($_GET['arr']))
			   ...
			   $query="SELECT * FROM admin_sent_message ORDER by $sort $arrange LIMIT {$startpoint} , {$limit}";
			   $res=mysql_query($query); 
			   
			   
			    $statement = "admin_sent_message ORDER by $sort $arrange";
			   ...
			   $query="SELECT * FROM admin_sent_message WHERE message_subject LIKE '%".$name."%' ";
			   $res=mysql_query($query);
			   }
			   //search
			  ...
			  $sql="SELECT * FROM admin_sent_message LIMIT {$startpoint} , {$limit}";
			  $res=mysql_query($sql);
			  
			  
			     $statement = "admin_sent_message";
			  ...
			  //var_dump($sname);die();
				...
				$query=mysql_query("UPDATE admin_sent_message SET dentist_name='".$name."' WHERE id='".$msg_id."'");
	...
	{ $back="#e0eefa";}
              ...
              <!--check--></td>
              <!--name--><td style="width:190px;padding-left:20px;padding-top:10px;padding-bottom:10px;text-align:left;">
              <a href="read_message.php?key=<?php echo $row["id"];?>" style="text-decoration:none;color:#373838;"><div>
			  <?php echo $name;?></div></a>
              <!--name--></td>
                <!--subject--><td style="width:194px;padding-left:20px;padding-top:10px;padding-bottom:10px;text-align:left;">
              <div><?php echo $row["message_subject"];?></div>
              <!--subject--></td>
              <!--last visit--><td style="width:208px;padding-top:10px;padding-bottom:10px;text-align:center;">
              <div><?php echo $row["message_date"];?></div>
              <!--last visit--></td>
              <!--action-->
             <?php /*<table cellpadding="0" cellspacing="0" border="0">
             <tr>
             <!--read--><td width="25" style="padding-left:20px;"><a href="read_message.php?key=<?php echo $row["id"];?>" title="Read email"> <img src="../img/icon_address_send.png" width="18" height="16"/></a></td>
