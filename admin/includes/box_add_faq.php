...
$sql="INSERT INTO faq (date,question,answer) VALUES(NOW(),'$question','$answer')";
$res=mysql_query($sql);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table width="739" border="0" align="center" cellpadding="0" cellspacing="0">
     ...
     <input type="submit" name="search" value="SEARCH" class="submit" style="margin-right:17px;margin-top:-4px;" /></td>-->
      ...
      <tr>
        ...
        Add FAQ
             ...
             <td style="padding-left:10px;padding-top:10px;"><input type="text" name="question" style="width:300px;"/></td>
             </tr>
     ...
     <textarea name="content" style="width:650px;height:350px;"></textarea>  
