...
if($i>=1) {
$sql="SELECT * FROM dentist_list WHERE id='".$email."'";
...
<input type="checkbox" name="check" value="<?php echo $row["patient_email"];?>" /></td>
        ...
        <td colspan="2" valign="top" style="background:url(../img/3.jpg); padding-bottom:10px;"><div style="margin-top:-8px; position: relative;">
          <table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <input type="submit" name="compose" value="Send" class="submit2"/> &nbsp;&nbsp;<input type="button" name="cancel" value="Cancel" class="submit2" onclick="javascript:history.go(-1)"/>
              </td>
              </tr>
              <!--button place--></table>
              </td></tr>
              ...
              <table cellpadding="0" cellspacing="0" border="0">
              <tr><td>Send to all dentist:</td>
              <td style="padding-left:10px;">
              <input type="checkbox" name="all_den" value="yes" />
              </td>
              </tr>
              </table>
...
<option value="unread">sort by Unread</option>
              ...
              <!--patient name-->
              <input type="hidden" value="<?php echo $name;?>" name="pt_name" />
              <input type="hidden" value="<?php echo $idy;?>" name="den_id" />
              <!--patient name-->
