...
$sqls=mysql_query("UPDATE newsletter SET newsletter_date='".$date."',newsletter_subject='".$subject."',newsletter_content='".$content."',newsletter_receiver='".$receivers."' WHERE id='".$news_id."'");	
...
$content=stripslashes($row['newsletter_content']);
$to=$row['newsletter_receiver'];
}
$date=explode("-",$date);
$y=$date[0];
$m=$date[1];
      ...
      <tr>
        <td colspan="2" valign="top" style="background:url(../img/3.jpg); padding-bottom:10px;"><div style="margin-top:-8px; position: relative;">
         ...
         Add Newsletter
             ...
             <option value="dentist" <?php echo (($to=="dentist")?"selected":"")?>>Dentist</option>
             <option value="patient" <?php echo (($to=="patient")?"selected":"")?>>Patient</option>
             <option value="all" <?php echo (($to=="all")?"selected":"")?>>All</option>
             </select>
             </td>
             </tr>
             ...
             <td style="padding-left:10px;padding-top:10px;"><input type="text" name="txtDate" value="<?php echo $date;?>" style="width:200px;"/></td>
             </tr>
             
             <tr><td style="width:120px;text-align:left;padding-top:10px;padding-left:20px;">
             Newsletter Subject:
             </td>
             <td style="padding-left:10px;padding-top:10px;"><input type="text" name="subject" style="width:200px;" value="<?php echo $subject;?>"/></td>
             </tr>
