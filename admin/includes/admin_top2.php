...
<ul class="cssMenu">
	<li>
		...
		<ul>
			<li><a href="admin_account.php"><div style="width:116px;height:29px;color:#13749a;">
			...
			<li><a href="includes/logout.php"><div style="width:116px;height:29px;color:#13749a;"><table cellpadding="0" cellspacing="0" border="0" style="padding-top:5px;width:56px;">
...
Admin's Dashboard</span>--><img src="../img/admin_dashboard.png" />
</div>
<div style="float:right;">
