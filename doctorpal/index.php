...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table width="973" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="290" style="background:url(../myclinicpal/img/bg-banner.jpg); background-position:bottom;"><div style="width:953px; margin:0 auto; z-index:1"><div style=" position:absolute; width:953px;margin-top:-145px;"><a href="#test"><img src="img/other pages/doctor_rev1.jpg" alt="" width="953" height="271" border="0" usemap="#Map" /></a></div></div></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td><table width="946" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <img src="img/other pages/doc_top.png" width="283" height="112" border="0" usemap="#Map2" />
        </td></tr>
        <tr><td style="padding-top:10px;"><img src="img/other pages/doc_bot.png" width="282" height="111" border="0" usemap="#Map3" /></td></tr>
        </table>
    ...
    <i style="font-size:18px;color:#d58139;">DOCTORPAL DASHBOARD?</i>
        </td></tr>
        ...
        &nbsp;-&nbsp;
         <span style="color:#333;font-size:14px;">This is where a doctor can add, edit, delete, search and print the patient's in formation</span>
        </td>
        </tr>
        </table>
        </td></tr>
        ...
        &nbsp;-&nbsp;
         <span style="color:#333;font-size:14px;">Doctors can message their patients regarding schedule and other related information and vice-versa.</span>
        </td>
        </tr>
        </table>
        </td></tr>
        ...
        &nbsp;-&nbsp;
         <span style="color:#333;font-size:14px;">Each doctor can add, edit, delete, search and print the list of patients in the address book of the website.</span>
        </td>
        </tr>
        </table>
        </td></tr>
        ...
        &nbsp;-&nbsp;
         <span style="color:#333;font-size:14px;">Each doctor will be informed regarding on everyday appointments and commitments.</span>
        </td>
        </tr>
        </table>
        </td></tr>
        ...
        <a href="#"><img src="../img/other pages/doc_access1.png" width="285" height="97" /></a>
