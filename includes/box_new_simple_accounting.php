...
<td style="text-align:right;border:1px solid #CCC;padding-right:10px;padding-top:10px;padding-bottom:10px;"><?php//$price1x=(preg_replace("," , "" , $));?>
P&nbsp;<?php $price1x=(str_replace("," , "" , $price1)); $tot=$price1x * $qty1; echo number_format($tot);?>&nbsp;.00
</td></tr>
