...
function popup(windowname) {
	...
	var mave = document.getElementById('to').value;
document.submitform.test.value=mave;	
	alert(document.submitform.test.value);
}
...
<tr><td>
<input type="button" name="ok" class="submit3" value="Done" id="done" onclick="popup('popUpDiv')"/>
&nbsp;&nbsp;&nbsp;
<input type="button" name="cancel" class="submit3" value="Cancel" onClick="popup('popUpDiv')"/>
<!--</form>-->
</td></tr>
</table>
</form>
...
$rows=$query['num'];?>
      ...
      <form method="post" action="send2.php" enctype="multipart/form-data" name="submitform">
      <tr>
...
<option value="unread">sort by Unread</option>
              ...
              <input type="submit" name="compose" value="Send" class="submit2"/>&nbsp;&nbsp;<input type="button" name="cancel" value="Cancel" class="submit2" onclick="javascript:history.go(-1)"/>&nbsp;&nbsp;<input type="file" name="fileatt" />
