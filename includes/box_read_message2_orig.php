        ...
        <td colspan="2" valign="top" style="background:url(img/3.jpg); padding-bottom:10px;"><div style="margin-top:-8px; position: relative;">
          <table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <tr><td style="font-weight:bold;color:#373838;font-size:14px;padding-top:10px;width:530px;">
              ...
              <td style="font-weight:bold;color:#373838;font-size:14px;padding-top:10px;">
              ...
              <tr><td width="100%">
              <?php echo stripslashes($row["body_message"]);?>
              </td></tr>
              </table>
              </td>
              <!--middle--></tr>
