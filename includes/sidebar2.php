...
<!--leftbox--><div style="float:left;width:205px;height:290px;">
...
<div id="nav2" class="navside2" style="float:left;border:1px solid #ccd3da;height:38px;width:90%;background-color:<?php if($back_now2) { echo $back_now2; } else { echo "#fff";}?>;"><a href="add_patient.php" id="link2" style="color:<?php if($color_now2) { echo $color_now2; } else { echo "#333"; }?>;text-decoration:none;" onclick="ChangeDesign(2)">
...
<div id="nav7" class="navside3" style="float:left;border:1px solid #ccd3da;height:38px;width:90%;background-color:<?php if($back_now7) { echo $back_now7; } else { echo "#fff";}?>;-moz-border-radius-bottomleft:10px;
 -moz-border-radius-bottomright:10px;

 -webkit-border-bottom-left-radius:10px;
 -webkit-border-bottom-right-radius:10px;"><a href="blog.php" id="link7" style="color:<?php if($color_now7) { echo $color_now7; } else { echo "#333"; }?>;text-decoration:none;" onclick="ChangeDesign(7)"> 
