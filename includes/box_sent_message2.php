 ...
 if(isset($_POST['reply']))
{
	...
	if(count($_POST["check"]) >= 2) {
		...
		if($_POST["check"][$i] != "") {
			$qwerty="SELECT * FROM message_sent WHERE id='".$_POST['check'][$i]."'";
	...
	//end else
	header('Location: read_message.php?key='.$id.'');
	}
	//end else
	}
          ...
          <div style="width:110px; margin-left:10px; margin-bottom:-2px; float:left">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="661" align="center" style="background: url(img/u3.jpg);"><a href="message_sent.php"><img src="img/t-sent.png" width="72" height="17" alt="" /></a></td>
...
$rows=$query['num'];?>
      ...
      <tr>
        ...
        <img src="img/message_sent_blue.png" height="21" width="141" style="margin-top:-8px;margin-left:23px;"/></td>
          ...
          <table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
             ...
             <!--<input type="button" name="compose" value="Compose Message" class="submit2" onclick="window.location='message_compose.php'"/>-->
              ...
              <div style="float:left;background-image:url(img/option_name_repeat.png);width:189px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;"><a href="message_sent.php?arr=patient_name" style="text-decoration:underline;color:#333;" title="Sort by Name">To</a></div>
              <div style="float:left;background-image:url(img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--name holder-->
              ...
              <!--subject holder-->
              <div style="float:left;">
              <div style="float:left;background-image:url(img/option_name_repeat.png);width:190px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;"><a href="message_sent.php?arr=subject_message" style="text-decoration:underline;color:#333;" title="Sort by Subject">Subject</a></div>
              <div style="float:left;background-image:url(img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--subject holder-->
              ...
              <!--last visit-->
              <div style="float:left;">
              <div style="float:left;background-image:url(img/option_name_repeat.png);width:140px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;"><a href="message_sent.php?arr=date_message" style="text-decoration:underline;color:#333;" title="Sort by Date">Date</a></div>
              <div style="float:left;background-image:url(img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--last visit-->
               ...
               <!--action holder-->
              <div style="float:left;">
              <div style="float:left;background-image:url(img/option_name_repeat.png);width:23px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;">&nbsp;</div>
              <div style="float:left;background-image:url(img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--action holder-->
    	...
    	$startpoint = ($page * $limit) - $limit;
		 //$statement = "`records` where `active` = 1";
			  ...
			  if(isset($_GET['arr']))
			   ...
			   if($sort_by=="date_message")
			   { $sort="date_message"; 
			   $arrange="DESC";
			   }
			   else if($sort_by=="patient_name")
			   { $sort="patient_name";
			   $arrange="ASC";
			   }
			   
			   else if($sort_by=="subject_message")
			   { $sort="subject_message"; 
			   $arrange="ASC";
			   }
			   ...
			   $query="SELECT * FROM message_sent WHERE dentist_id='".$dentist_id."' ORDER by $sort $arrange LIMIT {$startpoint} , {$limit}";
			   $res=mysql_query($query);
			   
			    $statement = "message_sent WHERE dentist_id='".$dentist_id."' ORDER by $sort $arrange";
			   ...
			   $query="SELECT * FROM message_sent WHERE patient_name LIKE '%".$name."%' AND dentist_id='".$dentist_id."'";
			   $res=mysql_query($query);
			   }
			   //search
			  ...
			  $sql="SELECT * FROM message_sent WHERE dentist_id='".$dentist_id."' LIMIT {$startpoint} , {$limit}";
			  $res=mysql_query($sql);
			  
			   $statement = "message_sent WHERE dentist_id='".$dentist_id."'";
	...
	$file=$file;	
              ...
              <!--check--></td>
              <!--name--><td style="width:190px;padding-top:10px;padding-bottom:10px;text-align:left;padding-left:20px;">
              <a href="read_message.php?key=<?php echo $row["id"];?>" style="text-decoration:none;color:#373838;"><div><?php echo $row["patient_name"];?></div></a>
              <!--name--></td>
                <!--subject--><td style="width:194px;padding-top:10px;padding-bottom:10px;text-align: left;padding-left:20px;">
              <div><?php echo $row["subject_message"];?></div>
              <!--subject--></td>
              <!--last visit--><td style="width:168px;padding-top:10px;padding-bottom:10px;text-align: center;">
              <div><?php echo $sent1;?></div>
              <!--last visit--></td>
              <td style="width:40px;padding-top:10px;padding-bottom:10px;text-align: center;">
              <?php if($file!="") { ?>
             ...
             <tr>
             <!--read--><td width="25" style="padding-left:20px;"><a href="read_message.php?key=<?php echo $row["id"];?>" title="Send email"><img src="img/icon_address_send.png" width="18" height="16"/></a></td>
             <!--print--><!--<td width="25"><img src="img/icon_print.png" height="16" width="16"/></td>-->
             <!--delete--><td><a href="message_sent.php?id=<?php echo $row["id"];?>" onclick="return onDelete();" title="Delete"><img src="img/icon_address_delete.png" width="15" height="15"/></a></td>
             <td></td>
             </tr>
             </table>*/?>
              <!--action-</td>-->
