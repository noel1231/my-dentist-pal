...
</td><td style='padding-left:10px;width:20px;'><input type='checkbox' name='tax0' id='tax0' value="no" onchange="Multiply(0)" style="display:none;"/></td><td style='padding-left:10px;width:90px;'><input type='text' name='price[]' style='width:90px;' value='0.00' id='price0' onchange="ChangePrice(0)"></td><td style='padding-left:10px;width:60px;'><input type='text' style='border:none;width:60px;background-color:#FFF;' id='tot0' name='total[]' value='P0.00' disabled="disabled"/></td></tr></table>
</div>
</div><!--end of table1-->
...
<table cellpadding="0" width="620" cellspacing="0" border="0" style="font-weight:bold;font-size:12px;font-family:Arial, Helvetica, sans-serif;">
