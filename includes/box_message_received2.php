...
if(isset($_POST['reply']))
{
	...
	if(count($_POST["check"]) >= 2) {
		...
		for($i=0;$i<count($_POST["check"]);$i++){
		if($_POST["check"][$i] != "") {
			$qwerty="SELECT * FROM message_received WHERE id='".$_POST['check'][$i]."'";
			$res=mysql_query($qwerty);
...
$rows=$query['num'];?>
          ...
          <table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
             ...
             <!--<input type="button" name="compose" value="Compose Message" class="submit2" onclick="window.location='message_compose.php'"/>--><table cellpadding="0" cellspacing="0" border="0">
              ...
              <div style="float:left;background-image:url(img/option_name_repeat.png);width:187px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;text-align:center;"><a href="message_received.php?arr=patient_name" style="text-decoration:underline;color:#333;" title="Sort by Name">Name</a></div>
              <div style="float:left;background-image:url(img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--name holder-->
              ...
              <!--subject holder-->
              <div style="float:left;">
              <div style="float:left;background-image:url(img/option_name_repeat.png);width:182px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;text-align:center;"><a href="message_received.php?arr=message_subject" style="text-decoration:underline;color:#333;" title="Sort by Subject">Subject</a></div>
              <div style="float:left;background-image:url(img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--subject holder-->
              ...
              <!--last visit-->
              <div style="float:left;">
              <div style="float:left;background-image:url(img/option_name_repeat.png);width:188px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;text-align:center;"><a href="message_received.php?arr=message_date" style="text-decoration:underline;color:#333;" title="Sort by Date">Date</a></div>
              <div style="float:left;background-image:url(img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--last visit-->
    	...
    	$startpoint = ($page * $limit) - $limit;
		 //$statement = "`records` where `active` = 1";
			  ...
			  if(isset($_GET['arr']))
			   ...
			   $query="SELECT * FROM message_received WHERE dentist_id='".$dentist_id."' ORDER by $sort $arrange LIMIT {$startpoint} , {$limit}";
			   $res=mysql_query($query); 
			   
			    $statement = "message_received WHERE dentist_id='".$dentist_id."' ORDER by $sort $arrange";
			   ...
			   $query="SELECT * FROM message_received WHERE message_subject LIKE '%".$name."%' AND dentist_id='".$dentist_id."'";
			   $res=mysql_query($query);
			   }
			   //search
			  ...
			  $sql="SELECT * FROM message_received WHERE dentist_id='".$dentist_id."' LIMIT {$startpoint} , {$limit}";
			  $res=mysql_query($sql);
			  
			   $statement = "message_received WHERE dentist_id='".$dentist_id."'";
	...
	{ $back="#e0eefa";}
			  ...
			  ?>
              <tr style="background-color:<?php echo $back;?>;font-weight:<?php echo $weight;?>;font-size:15px;">
              <!--check--><td width="58" style="padding-bottom:10px;padding-top:10px;text-align:center;">
              ...
              <!--name--><td style="width:183px;padding-top:10px;padding-bottom:10px;padding-left:10px;text-align:left;">
              <?php 
              ...
              <a href="read_message.php?id=<?php echo $row["id"];?>" style="text-decoration:none;color:#373838;"><div"><?php 
			    if($pt_id=="admin") {
			...
			$pt_name="admin";
			  ...
			  $query="UPDATE message_received SET patient_name='".$pt_name."' WHERE id='".$msg_id."'";
			  $result=mysql_query($query);
			  //var_dump($pt_name);
			  
			  ?></div></a>
              <!--name--></td>
                <!--subject--><td style="width:165px;padding-bottom:10px;padding-top:10px;padding-left:20px;text-align:left;">
              <div><?php echo $row["message_subject"];?></div>
              <!--subject--></td>
              <!--last visit--><td style="width:194px;padding-top:10px;padding-bottom:10px;text-align:center;">
              <div><?php echo $row["message_date"];?></div>
              <!--last visit--></td>
              <!--action--><!--<td width="108" style="padding-bottom:10px;padding-top:10px;">-->
             <?php /*<table cellpadding="0" cellspacing="0" border="0">
             <tr>
             <!--read--><td width="25" style="padding-left:20px;"><a href="read_message.php?id=<?php echo $row['id'];?>" title="Send email"><img src="img/icon_address_send.png" width="18" height="16"/></a></td>
