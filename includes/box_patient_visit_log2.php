 ...
 <!--date holder-->
	...
	{ $back="#e0eefa";}
          ...
          <?php echo $row['tooth_num'];?>
            ...
            <td width="92" style="font-family:Arial, Helvetica, sans-serif;color:#7a7d7f;font-size:14px;text-align:center;padding-top:8px;padding-bottom:5px;"> 
          <?php echo $row['surface'];?>
           </td>
            <td width="152" style="font-family:Arial, Helvetica, sans-serif;color:#7a7d7f;font-size:14px;text-align:center;padding-top:8px;padding-bottom:5px;"> 
          <?php echo $row['treatment_notes'];?>
           </td>
            <td width="84" style="font-family:Arial, Helvetica, sans-serif;color:#7a7d7f;font-size:14px;text-align:center;padding-top:8px;padding-bottom:5px;"> 
           <?php echo $row['intial'];?>
           </td>
           <td width="76" style="font-family:Arial, Helvetica, sans-serif;color:#7a7d7f;font-size:14px;text-align:center;padding-top:8px;padding-bottom:5px;"> 
          <?php echo $row['fee'];?>
           </td>
