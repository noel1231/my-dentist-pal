...
{  
a = document.getElementById('init').value;
b = document.getElementById('fee').value;

a = a.replace(/\,/g,'');
b = b.replace(/\,/g,'');

document.getElementById('init').value = a ;
document.getElementById('fee').value = b;
...
mave += '';
	...
	//return x1 + x2;
	var mave =x1 + x2;
document.getElementById('init').value=mave;
}

function ChangeFee(a) {
var mave = a;
mave += '';
	x = mave.split('.');
	x1 = x[0];
	...
	//return x1 + x2;
	var mave =x1 + x2;
document.getElementById('fee').value=mave;
}
...
echo "..." ;
  ...
  <area shape="rect" coords="579,3,633,31" href="patient_notes.php?id=<?php //echo $id;?>" />
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <td style="padding-left:28px;"><input type="text" name="tooth_num" style="width:70px;font-size:15px;"/></td>
            </tr>
            <tr><td><div style="clear:both;height:15px;"></div></td></tr>
            <tr><td style="width:160px;text-align:right;color:#333;font-size:14px;font-weight:bold;">
            Surface:
            ...
            <td style="padding-left:28px;color:#333;font-size:14px;"><textarea name="treatment_notes" cols="45" rows="3" style="font-size:15px;font-family:Arial, Helvetica, sans-serif;"/></textarea></td>
            </tr>
            <tr><td><div style="clear:both;height:15px;"></div></td></tr>
            <tr><td style="width:160px;text-align:right;color:#333;font-size:14px;font-weight:bold;">
            Initial:
            </td>
            <td style="padding-left:20px;color:#333;font-size:14px;;">P&nbsp;<input type="text" id="init" name="initial" onchange="ChangeInit(this.value)" style="font-size:15px;width:100px;text-align:right;"/>&nbsp;.00</td>
            </tr>
            <tr><td><div style="clear:both;height:15px;"></div></td></tr>
            <tr><td style="width:160px;text-align:right;color:#333;font-size:14px;font-weight:bold;">
            Fee:
            </td>
            <td style="padding-left:20px;color:#333;font-size:14px;;">P&nbsp;<input type="text" onchange="ChangeFee(this.value)" id="fee" name="fee" style="font-size:15px;width:100px;text-align:right;"/>&nbsp;.00</td>
            </tr>
