...
echo "..." ;
           ...
           -->
            ...
            <div style="clear:both;height:10px;"></div>
             ...
             <!--firstcontent--><table cellpadding="0" cellspacing="0" border="0" style="padding-left:20px;">
              ...
              <!--last visit-->
              <div style="float:left;">
              <div style="float:left;background-image:url(img/option_name_repeat.png);width:110px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;">Description</div>
              <div style="float:left;background-image:url(img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--last visit-->
              ...
              <!--action holder-->
                ...
                <!--last visit-->
              <div style="float:left;">
              <div style="float:left;background-image:url(img/option_name_repeat.png);width:85px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;">Marks</div>
              <div style="float:left;background-image:url(img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--last visit-->
	...
	$date_due_now=$m."-".$d."-".$y;
              ...
              <td style="padding-top:10px;width:132px;text-align:center;padding-bottom:10px;">
