    ...
    <td height="156" style="background:url(myclinicpal/img/top-bg-head.gif);"><table width="993" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="971" valign="bottom" style="background:url(myclinicpal/img/head-bottom.gif); background-position:bottom; background-repeat:repeat-x;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><div><div  style="position: relative; z-index:2"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','myclinicpal/img/nav1a.gif',1)"><img src="myclinicpal/img/nav1.gif" name="Image4" width="169" height="59" border="0" id="Image4" /></a><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image5','','myclinicpal/img/nav2agif.gif',1)"><img src="myclinicpal/img/nav2.gif" name="Image5" width="142" height="59" border="0" id="Image5" /></a><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image6','','myclinicpal/img/nav3a.gif',1)"><img src="myclinicpal/img/nav3.gif" name="Image6" width="150" height="59" border="0" id="Image6" /></a><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image7','','myclinicpal/img/nav4a.gif',1)"><img src="myclinicpal/img/nav4.gif" name="Image7" width="128" height="59" border="0" id="Image7" /></a><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image8','','myclinicpal/img/nav5a.gif',1)"><img src="myclinicpal/img/nav5.gif" name="Image8" width="157" height="59" border="0" id="Image8" /></a></div></div></td>
          </tr>
          <tr>
  ...
  <tr>
    <td><table width="946" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <tr><td style="font-size:18px;color:#d58139;padding-left:10px;">
        <i>SCREENSHOTS</i>
        </td></tr>
        
        <tr><td style="padding-top:20px;">
        <img src="myclinicpal/img/sc1.png" width="286" height="111" border="0" usemap="#Map2" />
        </td></tr>
        <tr><td style="padding-top:10px;"><img src="myclinicpal/img/sc2.png" width="282" height="114" border="0" usemap="#Map3" /></td></tr>
        </table>
      
        </td>
        
        <td style="padding-top:50px;padding-left:15px;"><img src="myclinicpal/img/sep.png" width="5" height="277"/></td>
        
        <td style="padding-left:10px;" valign="top">
        
        <table cellpadding="0" cellspacing="0" border="0" style="width:270px;padding-top:40px;">
        <tr><td style="font-size:18px;color:#274783;padding-left:10px;">
        WHAT WILL YOU GET IN 
        </td></tr>
        <tr><td style="padding-left:10px;font-size:18px;color:#274783;">
        THE <i style="font-size:18px;color:#d58139;">DENTISTS DASHBOARD?</i>
        </td></tr>
        
        <tr><td style="padding-top:20px;">
        <table cellpadding="0" cellspacing="0" border="0">
        <tr><td valign="top">
        <img src="myclinicpal/img/check.png" width="11" height="11" />
        </td>
        <td width="260" style="padding-left:8px;">
        <span style="color:#274783;font-size:14px;">PATIENT DATABASE</span>
        &nbsp;-&nbsp;
         <span style="color:#333;font-size:14px;">This is where a dentist can add, edit, delete, search and print the patient's in formation</span>
        </td>
        </tr>
        </table>
        </td></tr>
        ...
        <td width="260" style="padding-left:8px;">
        <span style="color:#274783;font-size:14px;">MESSAGING</span>
        &nbsp;-&nbsp;
         <span style="color:#333;font-size:14px;">Dentist can message their patients regarding dental schedule and other related dental information and vice-versa.</span>
        </td>
        </tr>
        </table>
        </td></tr>
        ...
        <td width="260" style="padding-left:8px;">
        <span style="color:#274783;font-size:14px;">ADDRESSBOOK</span>
        &nbsp;-&nbsp;
         <span style="color:#333;font-size:14px;">Each dentist can add, edit, delete, search and print the list of patients in hte address book of the website.</span>
        </td>
        </tr>
        </table>
        </td></tr>
        ...
        <td width="260" style="padding-left:8px;">
        <span style="color:#274783;font-size:14px;">SCHEDULER</span>
        &nbsp;-&nbsp;
         <span style="color:#333;font-size:14px;">Each dentist will be informed regarding on everyday dental appointments and commitments.</span>
        </td>
        </tr>
        </table>
        </td></tr>
         ...
         <td style="padding-top:50px;padding-left:10px;"><img src="myclinicpal/img/sep.png" width="5" height="277"/></td>
        
        <td style="padding-left:15px;" valign="top">
        
        <table cellpadding="0" cellpadding="0" cellspacing="0" border="0" style="padding-top:40px;">
        ...
        <a href="dentist_login.php"><img src="myclinicpal/img/dentist_acc.png" width="285" height="97" /></a>
         ...
         <a href="patient/login.php"><img src="myclinicpal/img/patient_acc.png" width="285" height="97" /></a>
...
?>
      ...
      <tr>
        <td width="535" class="footer_nav"><a href="#" class="b">HOME</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" class="b">ABOUT</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" class="b">SERVICES</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" class="b">SUBSCRIBE</a>&nbsp;		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" class="b">CONTACT US</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" class="b">ADVERTISE</a></td>
...
<map name="Map2" id="Map2">
  <area shape="rect" coords="7,3,134,110" href="lightbox2.05/images/fs1.png" rel="lightbox"/>
  <area shape="rect" coords="149,2,274,109" href="lightbox2.05/images/fs2.png" rel="lightbox" />
</map>

<map name="Map3" id="Map3">
  <area shape="rect" coords="8,4,133,110" href="lightbox2.05/images/fs3.png" rel="lightbox" />
  <area shape="rect" coords="148,3,273,110" href="lightbox2.05/images/fs4.png" rel="lightbox" />
</map>
</body>
</html>
