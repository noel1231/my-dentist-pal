...
*/
//$baseUrl = 'http://cavite.info/members/mywebsite/ckfinder/userfiles/';
...
*/
//$baseDir = resolveUrl($baseUrl);
//$baseDir = "/home/cavite/public_html/members/mywebsite/ckfinder/userfiles/";
	session_start();
	
$id=$_SESSION["SESS_ACCOUNT_ID"];

	$baseUrl = 'http://cavite.info/members/mywebsite/ckfinder/userfiles/images/'.$id.'/';
...
$Dir="/home/cavite/public_html/members/mywebsite/ckfinder/userfiles/images/".$id;
//var_dump($acctId);die();
if ("/home/cavite/public_html/members/mywebsite/ckfinder/userfiles/images/".$id)
{ $baseDir= "/home/cavite/public_html/members/mywebsite/ckfinder/userfiles/images/".$id; 
//echo "yes";
}
else
{ mkdir("/home/cavite/public_html/members/mywebsite/ckfinder/userfiles/images/".$id); 
$baseDir= "/home/cavite/public_html/members/mywebsite/ckfinder/userfiles/images/".$id;
//echo "no";
} 
