...
?>
                          <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                              <td style="text-align:left;" width="250"><span style="font-size:15px;color:#333;font-family:Arial, Helvetica, sans-serif;"><?php echo "Today's Appointment";?></span></td>
...
$rows=$query['num'];?>
                          <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                              <td style="text-align:left;" width="250"><span style="font-size:15px;color:#333;font-family:Arial, Helvetica, sans-serif;"><?php echo "No. of unread message";?></span></td>
                      ...
                      <tr>
                        <td style="padding-top:10px;"><table cellpadding="0" cellspacing="0" border="0">
                          <tr>
                            <td style="text-align:left;" width="250"><span style="font-size:15px;color:#333;font-family: Arial, Helvetica, sans-serif;"><?php echo "No. of referrer";?></span></td>
                            <?php
$count = 0;
              ...
              <td width="100%"><table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  ...
                  <td style="background-image:url('img/landing_center_blue.png');height:46px;width:350px;color:#fbfdfe;font-size:22px;padding-left:20px;"><!--<img src="img/landing_announcement.png" width="191" height="33" style="margin-top:3px;"/>-->
                    <span style="font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif;color:#FFF;font-size:20px;">Announcement</span></td>
                  <td style="background-image:url('img/landing_right_blue.png');height:46px;width:7px;"></td>
                </tr>
              </table></td>
            </tr>
...
?>
                    ...
                    <tr>
                      <td style="padding-top:4px;"><span style="color:#757373;font-size:12px;">
...
?>
                    ...
                    <tr>
                      <td style="padding-top:4px;"><span style="color:#313030;font-size:13px;">
                        <?php 
$length=340;
              ...
              <td><table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  ...
                  <td style="background-image:url('img/landing_center_blue.png');height:46px;width:535px;padding-left:20px;"><!--<img src="img/landing_news.png" width="165" height="22" style="margin-top:3px;"/>-->
                    <span style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;color:#FFF;font-size:20px;">Activities</span></td>
                  <td style="background-image:url('img/landing_right_blue.png');height:46px;width:6px;"></td>
                </tr>
              </table></td>
            </tr>
            <tr>
              <td colspan="2" style="background-color:#fdfdfd;padding-bottom:20px;" width="100%" height="270" class="landing_box" valign="top"><table cellpadding="0" cellspacing="0" border="0" style="font-family:Arial, Helvetica, sans-serif;">
                <?php 
...
?>
                ...
                <tr>
                  <td style="padding-top:4px;padding-left:30px;"><span style="color:#757373;font-size:12px;">
...
?>
                ...
                <tr>
                  <td style="padding-top:4px;padding-left:30px;"><span style="color:#313030;font-size:13px;">
                    <?php 
$length=185;
...
?>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><a href="<?php echo $ban_link1;?>"><img src="admin/<?php echo $banner_top_left;?>" width="164" height="134"/></a></td>
                <td style="padding-left:10px;"><a href="<?php echo $ban_link2;?>"><img src="admin/<?php echo $banner_top_right;?>" width="164" height="134"/></a></td>
              </tr>
              <tr>
                <td style="padding-top:10px;"><a href="<?php echo $ban_link3;?>"><img src="admin/<?php echo $banner_bottom_left;?>" width="164" height="134"/></a></td>
                <td style="padding-top:10px;padding-left:10px;"><a href="<?php echo $ban_link4;?>"><img src="admin/<?php echo $banner_bottom_right;?>" width="164" height="134"/></a></td>
              </tr>
            </table></td>
          <!--sponsored section-->
          <!--sponsored section-->
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="900">
          ...
          <tr>
            <td width="50%"><table cellpadding="0" cellspacing="0" border="0">
              ...
              <!--profile--></td>
            <!--scehduler-->
            <td width="50%" align="right" valign="top" style="padding-left:20px;"><table cellpadding="0" cellspacing="0" border="0">
              <tr>
