<?php
include('config.php');
$varx="<tr><td style='padding-left:20px;'><select name='users' onchange='showUser(this.value)'></select></td><td style='padding-left:72px;padding-top:3px;padding-bottom:5px;' valign='top'><div id='txtHint'><b>Person info will be listed here.</b></div></td></tr>";
?>
<html>
<title>1</title><head>
