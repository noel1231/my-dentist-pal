...
$msg  ="<html><head><title>Patient Message</title></head>";
$msg .="<body>";
...
// More headers
$headers .= 'From: Your Friendly Patient ' . "\r\n";
...
if(mail($email,$sub_now,$reply2,$headers)) {
	//var_dump($sub);die();
$sql="INSERT INTO patient_message_sent (message_subject,message_date,message_content,dentist_id,patient_id) VALUES('$sub_now',NOW(),'$reply','$den_id','$pt_id')";
$res=mysql_query($sql);

	$sql="INSERT INTO message_received (patient_id,dentist_id,message_subject ,message_date,message_content) VALUES('$pt_id','$den_id','$sub_now',NOW(),'$reply')";
	$res=mysql_query($sql);
