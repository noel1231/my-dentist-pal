          ...
          <table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td bgcolor="#FFFFFF" style="border-left:1px solid #a0a8ac; border-bottom:1px solid #a0a8ac; border-right:1px solid #a0a8ac;"><!--<p>&nbsp;</p>-->
                ...
                <td style="background-color:#FFF;width:145px;height:36px;text-align:center;"> 
              ...
              <a href="patient_info_edit.php" style="color:#FFF;font-family:Arial, Helvetica, sans-serif;font-weight:bold;font-size:13px;text-decoration:none;">
               Edit
                </a>
                </td>-->
...
display_setting+="scrollbars=yes,width=770, height=600, left=80, top=25";
