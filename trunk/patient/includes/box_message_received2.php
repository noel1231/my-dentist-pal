...
if(isset($_GET['id'])) {
$id=$_GET['id'];
$sql="DELETE FROM patient_message_received WHERE id='".$id."'";
$res=mysql_query($sql);
}
if(isset($_POST['delete_all']))
{
		...
		if($_POST["check"][$i] != "") {
			$qwerty="DELETE FROM patient_message_received WHERE id='".$_POST['check'][$i]."'";
			$res=mysql_query($qwerty);
	}}
	}


$sql=mysql_query("SELECT dentist_id FROM patient_list WHERE id='".$patient_id."'");
...
if(isset($_POST['reply']))
{
	...
	if(count($_POST["check"]) >= 2) {
		...
		for($i=0;$i<count($_POST["check"]);$i++){
		if($_POST["check"][$i] != "") {
			$qwerty="SELECT * FROM patient_message_received WHERE id='".$_POST['check'][$i]."'";
			$res=mysql_query($qwerty);
       ...
       <div style="width:130px; margin-left:10px; margin-bottom:-2px; float:left; z-index:999999999">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="6"><img src="../img/t1.jpg" width="6" height="41" alt="" /></td>
                <td width="661" align="center" style="background: url(../img/t3.jpg);"><a href="message_compose.php"><img src="../img/t_compose.png" width="86" height="19" alt="" /></a></td>
                <td width="6"><img src="../img/t2.jpg" width="6" height="41" alt="" /></td>
              </tr>
            </table>
          </div>-->
...
$rows=$query['num'];?>
          ...
          <table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
             ...
             <table cellpadding="0" cellspacing="0" border="0">
              ...
              <!--subject holder-->
              <div style="float:left;">
              <div style="float:left;background-image:url(../img/option_name_repeat.png);width:191px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;"><a href="message_received.php?arr=subject_message" style="text-decoration:underline;color:#333;" title="Sort by Subject">Subject</a></div>
              <div style="float:left;background-image:url(../img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--subject holder-->
              ...
              <!--last visit-->
              <div style="float:left;">
              <div style="float:left;background-image:url(../img/option_name_repeat.png);width:120px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;"><a href="message_received.php?arr=date_message" style="text-decoration:underline;color:#333;" title="Sort by Subject">Date</a></div>
              <div style="float:left;background-image:url(../img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--last visit-->
    	...
    	$startpoint = ($page * $limit) - $limit;
		 //$statement = "`records` where `active` = 1";
			  ...
			  if(isset($_GET['arr']))
			   ...
			   $query="SELECT * FROM patient_message_received WHERE patient_id='".$patient_id."' ORDER by $sort $arrange LIMIT {$startpoint} , {$limit}";
			   $res=mysql_query($query); 
			   
			     $statement = "patient_message_received WHERE patient_id='".$patient_id."' ORDER by $sort $arrange";
			   ...
			   $query="SELECT * FROM patient_message_received WHERE patient_name LIKE '%".$name."%' AND patient_id='".$patient_id."'";
			   $res=mysql_query($query);
			   }
			   //search
			  ...
			  $sql="SELECT * FROM patient_message_received WHERE patient_id='".$patient_id."' LIMIT {$startpoint} , {$limit}";
			  $res=mysql_query($sql);
			  
			  $statement = "patient_message_received WHERE patient_id='".$patient_id."'";
			  ...
			  $query=mysql_query("UPDATE patient_message_received SET dentist_name='".$name_nows."' WHERE id='".$msg_id."'");
	...
	{ $back="#e0eefa";}
              ...
              <!--name--><td style="width:206px;padding-top:10px;padding-bottom:10px;text-align:left;padding-left:10px;">
              <a href="read_message.php?id=<?php echo $row["id"];?>" style="text-decoration:none;color:#373838;"><div><?php 
			   echo "Dr. $name_nows";?></div></a>
              <!--name--></td>
                <!--subject--><td style="width:212px;padding-top:10px;padding-bottom:10px;text-align:center;">
              <div><?php echo $row["subject_message"];?></div>
              <!--subject--></td>
              <!--last visit--><td style="width:144px;padding-top:10px;padding-bottom:10px;text-align:center;">
              <div><?php echo $row["date_message"];?></div>
              <!--last visit--></td>
             <?php /* <!--action--><td width="107" style="padding-top:10px;padding-bottom:10px;">
             <table cellpadding="0" cellspacing="0" border="0">
             <tr>
             <!--read--><td width="25" style="padding-left:20px;"><a href="read_message.php?id=<?php echo $row['id'];?>" title="Read email"><img src="../img/icon_address_send.png" width="18" height="16"/></a></td>
