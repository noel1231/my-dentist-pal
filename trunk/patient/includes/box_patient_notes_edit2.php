...
$sql="SELECT * FROM accounting_summary WHERE patient_id='".$id."'";
			$res=mysql_query($sql);
			$xxx=0;$yyy=0;
      ...
      <tr>
        <td colspan="2" valign="top" style="background:url(../img/3.jpg); padding-bottom:10px;"><div style="margin-top:-8px; position: relative;">
          <table id="print_it" width="690" border="0" align="center" cellpadding="0" cellspacing="0">
           ...
           <!-- <input type="button" name="add" value="Add" class="submit2" onclick="popup('popUpDiv')"/>-->
            ...
            Payed Balance: <span style="color:#06F;font-size:12px;font-weight:bold;">Php&nbsp;&nbsp;<?php echo number_format($yyy);?>.00</span>
           
            </td></tr>
             <tr><td style="font-color:#333;font-family:Arial, Helvetica, sans-serif;font-size:14px;text-align:right;">
          <?php 
		  $w=$xxx-$yyy;?>
            Credits Left: <span style="color:#F00;font-size:12px;font-weight:bold;">Php&nbsp;&nbsp;<?php echo number_format($w);?>.00</span>
            ...
            <div style="clear:both;height:10px;"></div>
             ...
             <!--firstcontent--><table cellpadding="0" cellspacing="0" border="0" style="padding-left:30px;">
              ...
              <div style="float:left;background-image:url(../img/option_name_repeat.png);width:95px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;">Date Noted</div>
              <div style="float:left;background-image:url(../img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--name holder-->
              ...
              <!--subject holder-->
              <div style="float:left;">
              <div style="float:left;background-image:url(../img/option_name_repeat.png);width:95px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;">Date Due</div>
              <div style="float:left;background-image:url(../img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--subject holder-->
              ...
              <!--last visit-->
              <div style="float:left;">
              <div style="float:left;background-image:url(../img/option_name_repeat.png);width:170px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:37px;">Description</div>
              <div style="float:left;background-image:url(../img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--last visit-->
    	...
    	$startpoint = ($page * $limit) - $limit;
		 //$statement = "`records` where `active` = 1";
			  ...
			  $sql="SELECT * FROM accounting_summary WHERE patient_id='".$id."' LIMIT {$startpoint} , {$limit}";
			  $res=mysql_query($sql);
			  
			  
			  $statement = "accounting_summary WHERE patient_id='".$id."'";
