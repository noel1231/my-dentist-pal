...
$yes="yes";
$sql="UPDATE patient_message_received SET message_read='".$yes."' WHERE id='".$idy."'";
$res=mysql_query($sql);
$sql="SELECT * FROM patient_message_received WHERE id=".$idy."";
$res=mysql_query($sql);
        ...
        <td colspan="2" valign="top" style="background:url(../img/3.jpg); padding-bottom:10px;"><div style="margin-top:-8px; position: relative;">
          <table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <tr><td style="font-weight:bold;color:#373838;font-size:12px;padding-top:10px;width:500px;">
              ...
              <td style="font-weight:bold;color:#373838;font-size:12px;padding-top:10px;width:150px;">
            ...
            <input type="hidden" name="pt_id" value="<?php echo $pt_id;?>" />
              ...
              <input type="hidden" name="subject" value="<?php echo $sub=$row["subject_message"];?>" />
               <!--</td>
            </tr>-->
            </table><!--</div>--></td></tr>
            </form>
