...
<div onclick="window.location='admin_landing.php'" style="float:left;"><!--left-->
<div style="float:left;" onclick="window.location='admin_landing.php'"><img src="../images/toothlogo.png" style="margin-top:15px;"/></div>
<div style="float:left;margin-left:10px;margin-top:20px;width:210px;"><a href="admin_landing.php" title="Go to Dashboard" style="text-decoration:none;font-family:Arial, Helvetica, sans-serif;font-size:32px;color:#FFF;">My Dentist Pal</a></div>
...
<ul class="cssMenu">
	<li>
		...
		<ul>
			<li><a href="http://leentechsystems.net/mydentistpal/dentist_account.php"><div style="width:116px;height:29px;color:#13749a;">
			...
			<li><a href="http://leentechsystems.net/mydentistpal/includes/logout.php"><div style="width:116px;height:29px;color:#13749a;"><table cellpadding="0" cellspacing="0" border="0" style="padding-top:5px;width:56px;">
...
<div style="float:left;margin-top:28px;"><!--Dentist's Dashboard--><img src="../img/admin_dashboard.png" /></div>
<div style="float:right;">
...
<?php include('includes/box_dentist_profile.php');?>
<!--content--></td>
</tr>
