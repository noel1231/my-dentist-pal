...
function onDelete()  
{  
if(confirm('Do you want to disable this dentist?')==true)  
{  
return true;  
}  
else  
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
          ...
          <table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
             ...
             <a href="message_compose.php"><input type="submit" name="compose" value="Compose Message" class="submit2"/></a>
              ...
              <div style="float:left;background-image:url(../img/option_name_repeat.png);width:150px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;">Name</div>
              <div style="float:left;background-image:url(../img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--name holder-->
              ...
              <!--subject holder-->
              <div style="float:left;">
              <div style="float:left;background-image:url(../img/option_name_repeat.png);width:145px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;">Date</div>
              <div style="float:left;background-image:url(../img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--subject holder-->
              ...
              <!--last visit-->
              <div style="float:left;">
              <div style="float:left;background-image:url(../img/option_name_repeat.png);width:160px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;">Status</div>
              <div style="float:left;background-image:url(../img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--last visit-->
	...
	{ $back="#e0eefa";}
              ...
              <!--check--></td>
              <!--name--><td style="width:163px;padding-top:10px;padding-left:10px;padding-bottom:10px;text-align:left;">
              <a href="read_message.php?id=<?php echo $row["id"];?>" style="text-decoration:none;color:#373838;"><div><?php echo $name;?></div></a>
              <!--name--></td>
                <!--subject--><td style="width:165px;padding-top:10px;padding-bottom:10px;text-align:center;">
              <div><?php echo $row["register_date"];?></div>
              <!--subject--></td>
              <!--last visit--><td style="width:200px;padding-top:10px;padding-bottom:10px;text-align:center;">
              <div><?php echo "Active";?></div>
              <!--last visit--></td>
              <!--action--><td width="100" style="padding-top:10px;padding-bottom:10px;">
             <table cellpadding="0" cellspacing="0" border="0">
             <tr>
             <td width="25" style="padding-left:20px;"><a href="dentist_profile.php?id=<?php echo $row['id'];?>" title="View"><img src="../img/user.png" width="16" height="16" /></a></td>
             <!--print--><td width="25"><a href="message_compose.php?id=<?php echo $row['id'];?>" title="Send email"><img src="../img/mail.png" width="16" height="16"/></a></td>
             <!--delete--><td><a href="dentist_list.php?id=<?php echo $row['id'];?>" onclick="return onDelete();" title="Delete"><img src="../img/delete_dl.png" width="16" height="16"/></a></td>
             </tr>
             </table>
              <!--action--></td>
              </tr>
