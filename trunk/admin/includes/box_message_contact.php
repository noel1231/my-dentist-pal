...
$sql="DELETE FROM mydentist_pal WHERE id=".$idy."";
$res=mysql_query($sql);
}*/
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
         ...
         <!-- <div style="width:140px; margin-left:20px; margin-bottom:-2px; float:left;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="661" align="center" style="background: url(../img/u3.jpg);"><a href="message_contact.php"><img src="../img/t-contact.png" width="95" height="12" alt="" /></a></td>
          ...
          <table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
             ...
             <input type="submit" name="delete_all" class="submit2" value="Delete" onclick="return onDelete();"/>
              ...
              <div style="float:left;background-image:url(../img/option_name_repeat.png);width:241px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;"><a href="message_contact.php?arr=sur_name" style="text-decoration:underline;color:#333;" title="Sort by Name">Name</a></div>
              <div style="float:left;background-image:url(../img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--name holder-->
              ...
              <!--subject holder-->
              <div style="float:left;">
              <div style="float:left;background-image:url(../img/option_name_repeat.png);width:100px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;">Group</div>
              <div style="float:left;background-image:url(../img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--subject holder-->
              ...
              <!--last visit-->
               ...
               <!--action holder-->
              <div style="float:left;">
              <div style="float:left;background-image:url(../img/option_name_repeat.png);width:223px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;"><a href="message_contact.php?arr=email" style="text-decoration:underline;color:#333;" title="Sort by Email">Email</a></div>
              <div style="float:left;background-image:url(../img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--action holder-->
		 ...
		 //$statement = "`records` where `active` = 1";
			  ...
			  $arrange="ASC";}*/
			   ...
			   $res=mysql_query($query); 
			     ...
			     $statement = "dentist_list WHERE allow_dentist='".$var."' ORDER by $sort $arrange";
			   ...
			   $query="SELECT * FROM dentist_list WHERE sur_name LIKE '%".$name."%' AND allow_dentist='".$var."'";
			   $res=mysql_query($query);
			   }
			   //search
			 ...
			 { $query="SELECT * FROM dentist_list WHERE allow_dentist='".$var."' LIMIT {$startpoint} , {$limit}";
			  $res=mysql_query($query); 
	...
	{ $back="#e0eefa";}
              ...
              <!--check--></td>
              <!--name--><td style="width:250px;padding-top:10px;padding-bottom:10px;text-align:left;padding-left:20px;">
             <a href="message_compose.php?id=<?php echo $row["id"];?>" style="text-decoration:none;color:#373838;">
             <div><!--Maverick Bersabe--><?php echo $name;?></div>
             </a>
              <!--name--></td>
                <!--subject<td style="width:165px;">
              <div style="margin-top:10px;margin-left:18px;">Good Morning</div>
              subject</td>-->
              <!--last visit--><td style="width:100px;padding-top:10px;padding-bottom:10px;text-align:left;padding-left:20px;">
              <div style="color:#373838;"><?php echo "Dentist";?></div>
              <!--last visit--></td>
              <!--action--><td width="230" style="padding-top:10px;padding-bottom:10px;text-align:left;padding-left:20px;">
            <?php /*<table cellpadding="0" cellspacing="0" border="0">
             ...
             <!--delete--><!--<td><a href="message_contact.php?id=<?php //echo $row["id"];?>" onclick="return onDelete();"><img src="../img/icon_address_delete.png" width="15" height="15"/></a></td>-->
             </tr>
             </table>*/?>
             <?php echo $row['email'];?>
              <!--action--></td>
...
?>
             ...
             <!--bottom button--><tr><td style="padding-left:15px;padding-top:15px;">
              ...
              <div style="float:left;">--><!--<input type="submit" name="delete_all" class="submit2" value="Delete all marked" onclick="return onDelete();"/>--><!--<input type="button" name="compose" value="Compose Message" class="submit2" onclick="window.location='message_compose.php'"/></div>-->
               <table cellpadding="0" cellspacing="0" border="0">
              <tr>
              <td>
              <input type="submit" name="emailthis" class="submit2" value="Email"  />
