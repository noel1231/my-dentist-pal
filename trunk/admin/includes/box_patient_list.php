...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
          ...
          <table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
             ...
             <a href="message_compose.php"><input type="submit" name="compose" value="Compose Message" class="submit2"/></a>
              ...
              <div style="float:left;background-image:url(../img/option_name_repeat.png);width:140px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;"><a href="patient_list.php?arr=patient_name" style="text-decoration:underline;color:#333;" title="Sort by Name">Full Name</div>
              <div style="float:left;background-image:url(../img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--name holder-->
              ...
              <!--subject holder-->
              <div style="float:left;">
              <div style="float:left;background-image:url(../img/option_name_repeat.png);width:185px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;"><a href="patient_list.php?arr=email" style="text-decoration:underline;color:#333;" title="Sort by Email">Email</a></div>
              <div style="float:left;background-image:url(../img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--subject holder-->
              ...
              <!--last visit-->
              <div style="float:left;">
              <div style="float:left;background-image:url(../img/option_name_repeat.png);width:160px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;"><a href="patient_list.php?arr=date_of_entry" style="text-decoration:underline;color:#333;" title="Sort by Date">Date Registered</a></div>
              <div style="float:left;background-image:url(../img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--last visit-->
               ...
               <!--action holder-->
              <div style="float:left;">
              <div style="float:left;background-image:url(../img/option_name_repeat.png);width:120px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;"><a href="patient_list.php?arr=dentist_name" style="text-decoration:underline;color:#333;" title="Sort by Date">Dentist Name</a></div>
    	...
    	$startpoint = ($page * $limit) - $limit;
		 //$statement = "`records` where `active` = 1";
            ...
            if(isset($_GET['arr']))
			   ...
			   $query="SELECT * FROM patient_list ORDER by $sort $arrange LIMIT {$startpoint} , {$limit}";
			   $res=mysql_query($query); 
			   
			    $statement = "patient_list ORDER by $sort $arrange";
			   ...
			   $query="SELECT * FROM patient_list WHERE patient_name LIKE '%".$name."%' ";
			   $res=mysql_query($query);
			   }
			   //search
			  ...
			  $url = "?";
			  $sql="SELECT * FROM patient_list LIMIT {$startpoint} , {$limit}";
			  $res=mysql_query($sql);
			  
			    $statement = "patient_list";
	...
	{ $back="#e0eefa";}
              ...
              <!--check--><!--</td>-->
              <!--name--><td style="width:161px;text-align:left;padding-left:10px;padding-top:10px;padding-bottom:10px;">
              <div><?php echo $row["patient_name"];?></div>
              <!--name--></td>
                <!--subject--><td style="width:208px;text-align:left;padding-left:10px;padding-top:10px;padding-bottom:10px;">
