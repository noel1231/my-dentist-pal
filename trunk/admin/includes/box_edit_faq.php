...
$answer=mysql_real_escape_string($_POST['content']);
$id=mysql_real_escape_string($_POST['faq_id']);

$sql="UPDATE faq SET date=NOW(),question='".$question."',answer='".$answer."' WHERE id='".$id."'";
$res=mysql_query($sql);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table width="739" border="0" align="center" cellpadding="0" cellspacing="0">
     ...
     <input type="submit" name="search" value="SEARCH" class="submit" style="margin-right:17px;margin-top:-4px;" /></td>-->
      ...
      <tr>
        ...
        Edit FAQ
             ...
             <td style="padding-left:10px;padding-top:10px;"><input type="text" name="question" style="width:300px;" value="<?php echo $row['question'];?>"/></td>
             </tr>
     ...
     <textarea name="content" style="width:650px;height:350px;"><?php echo $row['answer'];?></textarea>  
