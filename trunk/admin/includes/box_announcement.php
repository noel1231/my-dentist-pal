...
echo "<script>alert('Message box should not be empty');</script>";	
}
...
function MsgCheck() {
	 var msg = document.form1.message;
	 if(msg.value=='') {
        ...
        <td valign="top" style="background:url(../img/3.jpg);padding-bottom:10px;"><div style="margin-top:-8px; position: relative;">
          <table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td style="padding-left:20px;">
              <textarea name="message" id="message" rows="6" cols="63" style="font-family:Arial, Helvetica, sans-serif;font-size:15px;"></textarea>
              </td>
              </tr>
               <tr><td><div style="clear:both;height:20px;"></div></td></tr>
               <tr><td>&nbsp;</td>
               <td style="padding-left:20px;"><input type="submit" name="save" class="submit2" value="Save" onclick="return MsgCheck()"/>
               &nbsp;&nbsp;&nbsp;&nbsp;
