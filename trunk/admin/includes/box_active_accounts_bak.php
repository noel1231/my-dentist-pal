...
$sql="UPDATE dentist_list SET allow_dentist='".$var."' WHERE id='".$id."'";
$res=mysql_query($sql);
}
...
//echo "not ok";	
	...
	echo "<script>alert('You have successfully declined a dentist.');</script>";
	}
...
if(count($_POST["check"])==0) {
						...
						echo "<script>alert('Too many accounts to view. Please select one.');</script>";
					}
					else {
for($i=0;$i<count($_POST["check"]);$i++){
		if($_POST["check"][$i] != "") {
	...
	//end else
	//var_dump($group);die();
	header('Location: dentist_profile.php?id='.$id.'');
	}
}
...
mave++;	
	...
	if(mave>0) {
	if(confirm('Do you want to disable?')==true)  
	{  
	return true;  
	}  
	else  
...
function onCheck()  
{  
if(confirm('Do you want to remove this dentist?')==true)  
{  
return true;  
}  
else  
        ...
        <td height="39" colspan="2" valign="top"><div>
          ...
          <div style="width:130px; margin-left:20px; margin-bottom:-2px; float:left; z-index:999999999">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="6"><img src="../img/t1.jpg" width="6" height="41" alt="" /></td>
                <td width="661" align="center" style="background: url(../img/t3.jpg);"><a href="accounts.php" style="font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#3e4447;text-decoration:none;">Pending</a></td>
                <td width="6"><img src="../img/t2.jpg" width="6" height="41" alt="" /></td>
              </tr>
            </table>
          </div>
          <div style="width:130px; margin-left:10px; margin-bottom:-2px; float:left; z-index:999999999">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="6"><img src="../img/u1.jpg" width="6" height="41" alt="" /></td>
                <td width="661" align="center" style="background: url(../img/u3.jpg);"><a href="active_accounts.php" style="font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#3e4447;text-decoration:none;">Active</a></td>
                <td width="6"><img src="../img/u2.jpg" width="6" height="41" alt="" /></td>
              </tr>
            </table>
          </div>
      ...
      <tr>
          ...
          <table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
             ...
             <!--button place--><table cellpadding="0" cellspacing="0" border="0">
              ...
              <tr> <td>
            <input type="submit" name="delete_all" class="submit2" value="Disable" onclick="return onDelete();"/>
              </td>
              <td style="padding-left:10px;">
              <input type="submit" name="confirm" class="submit2" value="View"  />
              </td>
               <!--<td style="padding-left:10px;">
              ...
              <div style="float:left;background-image:url(../img/option_name_repeat.png);width:150px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;"><a href="active_accounts.php?arr=sur_name" style="text-decoration:underline;color:#333;" title="Sort by Name">Name</a></div>
              <div style="float:left;background-image:url(../img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--name holder-->
              ...
              <!--subject holder-->
              <div style="float:left;">
              <div style="float:left;background-image:url(../img/option_name_repeat.png);width:145px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;"><a href="active_accounts.php?arr=register_date" style="text-decoration:underline;color:#333;" title="Sort by Date">Registration Date</a></div>
              <div style="float:left;background-image:url(../img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--subject holder-->
              ...
              <!--last visit-->
              <div style="float:left;">
              <div style="float:left;background-image:url(../img/option_name_repeat.png);width:160px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;">No of patients</div>
              <div style="float:left;background-image:url(../img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--last visit-->
    	...
    	$startpoint = ($page * $limit) - $limit;
			  ...
			  if(isset($_GET['arr']))
			   ...
			   $query="SELECT * FROM dentist_list WHERE allow_dentist='".$var."' ORDER by $sort $arrange";
			  ...
			  $sql="SELECT * FROM dentist_list WHERE allow_dentist='".$var."'";
			  $res=mysql_query($sql);}
...
$sqls="SELECT COUNT(*) AS num FROM patient_list WHERE dentist_id='".$id."'";
$rese=mysql_query($sqls);
$querys=mysql_fetch_assoc($rese);
$rowss=$querys['num'];
$num=$rowss;
              ...
              <!--check--></td>
              <!--name--><td style="width:163px;text-align:left;padding-left:10px;padding-top:10px;padding-bottom:10px;">
             ...
             <table cellpadding="0" cellspacing="0" border="0">
             <tr>
             <td width="25" style="padding-left:20px;"><a href="dentist_profile.php?id=<?php echo $row['id'];?>" onclick="popup(this.href,'name','500','400','no'); return false" title="View"><img src="img/user.png" width="16" height="16" /></a></td>
             <!--print--><!--<td width="25"><a href="active_accounts.php?key=<?php //echo $row['id'];?>" onclick="return onCheck();"><img src="img/add.png" height="16" width="16"/></a></td>-->
             <!--delete--><td><a href="active_accounts.php?id=<?php echo $row['id'];?>" onclick="return onDelete();" title="Disable"><img src="img/delete.png" width="16" height="16"/></a></td>
             </tr>
             </table>
              <!--action--></td>
              </tr>
