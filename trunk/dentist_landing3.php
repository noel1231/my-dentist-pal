...
<!--sidebar and content container--><table width="100%" border="0" cellpadding="0" cellspacing="0">
...
<span style="font-size:15px;color:#333;font-family:Arial, Helvetica, sans-serif;"><?php echo "Today's Appointment";?></span>
</td>
...
<table cellpadding="0" cellspacing="0" border="0">
<tr><td style="text-align:left;" width="250">
<span style="font-size:15px;color:#333;font-family:Arial, Helvetica, sans-serif;"><?php echo "No. of unread message";?></span>
</td>
<td><a href="message_received.php" style="text-decoration:none;" target="_blank"><span style="font-size:14px;color:#F00;"><?php echo $rows;?></span></td>
</tr>
<tr><td colspan="2" style="border-bottom:1px #333 dotted;width:100%;padding-top:10px;"></td></tr>
...
<table cellpadding="0" cellspacing="0" border="0">
<tr><td style="text-align:left;" width="250">
<span style="font-size:15px;color:#333;font-family: Arial, Helvetica, sans-serif;"><?php echo "No. of referrer";?></span>
</td>
<?php
$count = 0;
...
?>
<td><span style="font-size:14px;color:#F00;"><?php echo $row;?></span></td>
</tr>
<tr><td colspan="2" style="border-bottom:1px #333 dotted;width:100%;padding-top:10px;"></td></tr>
...
<!--second-box--><td style="padding-left:5px;" valign="top">
...
<span style="color:#757373;font-size:12px;">
...
<tr><td style="padding-top:4px;">
<span style="color:#313030;font-size:13px;">
<?php 
$length=340;
...
<!--firstbox--></td><td style="padding-top:30px;" valign="top">
<?php 
$var="yes";
$type="side";
$ctr1=1;
...
<tr><td>
<a href="<?php echo $ban_link1;?>"><img src="admin/<?php echo $banner_top_left;?>" width="164" height="134"/></a>
</td>
<td style="padding-left:10px;">
<a href="<?php echo $ban_link2;?>"><img src="admin/<?php echo $banner_top_right;?>" width="164" height="134"/></a>
</td>
</tr>
<tr><td style="padding-top:10px;">
<a href="<?php echo $ban_link3;?>"><img src="admin/<?php echo $banner_bottom_left;?>" width="164" height="134"/></a>
</td>
<td style="padding-top:10px;padding-left:10px;">
<a href="<?php echo $ban_link4;?>"><img src="admin/<?php echo $banner_bottom_right;?>" width="164" height="134"/></a>
</td>
</tr>
</table>
...
<div style="margin:0 auto;width:920px;padding-left:20px;padding-right:20px;">
...
<a href="dentist_profile.php"><img src="img/profile.png" width="41" height="48" /></a>
</td>
<td style="padding-left:20px;">
<table cellpadding="0" cellspacing="0" border="0">
<tr><td>
<a href="dentist_profile.php" style="text-decoration:none;color:#2a91b4;font-size:18px;font-weight:bolder;font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif;">PROFILE</a>
</td></tr>
<tr><td style="color:#3b4244;font-size:13px;font-weight:bold;font-family:Arial, Helvetica, sans-serif;padding-top:6px;">
You can now create your profile or update your basic
<div style="clear:both;"></div>
information such as your office address,office hours etc.
</td></tr>
</table> 
</td>
</tr>
...
<table cellpadding="0" cellspacing="0" border="0">
<tr><td>
<a href="scheduler/wdCalendar/index.php" target="_blank"><img src="img/schedule.png" width="42" height="47" /></a>
</td>
...
<a href="scheduler/wdCalendar/index.php" style="text-decoration:none;color:#2a91b4;" target="_blank">SCHEDULER</a>
</td></tr>
<tr><td style="color:#3b4244;font-size:13px;font-weight:bold;font-family:Arial, Helvetica, sans-serif;padding-top:6px;">
You can check your everyday schedule by having your 
<div style="clear:both;"></div>
own personal scheduler.
</td></tr>
</table> 
</td>
</tr>
...
<img src="img/database.png" width="39" height="45" />
</td>
<td style="padding-left:20px;">
<table cellpadding="0" cellspacing="0" border="0">
<tr><td style="color:#2a91b4;font-size:18px;font-weight:bolder;font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif;">
...
<tr><td style="color:#3b4244;font-size:13px;font-weight:bold;font-family:Arial, Helvetica, sans-serif;padding-top:6px;">
Update your patient's status by adding, editing, deleting,
<div style="clear:both;"></div>
...
<!--scehduler-->
<td width="50%" align="right" valign="top" style="padding-left:20px;">
<table cellpadding="0" cellspacing="0" border="0">
<tr><td valign="top">
<a href="message_contact.php"><img src="img/message.png" width="43" height="43" /></a>
</td>
<td style="padding-right:30px;padding-left:20px;">
<table cellpadding="0" cellspacing="0" border="0">
<tr><td>
<a href="message_contact.php" style="text-decoration:none;color:#2a91b4;font-size:18px;font-weight:bolder;font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif;">MESSAGING</a>
</td></tr>
<tr><td style="color:#3b4244;font-size:13px;font-weight:bold;font-family:Arial, Helvetica, sans-serif;padding-top:6px;">
You can remind your patient for dental schedule. You 

may also answer your patient's inquiry or letting them know 

 your available time. In this messaging function, both you and

 your patient will be notified via email.
</td></tr>
</table> 
</td>
</tr>
