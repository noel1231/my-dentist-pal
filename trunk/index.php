...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table width="973" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="290" style="background:url(img/landing/top_back.jpg); background-position:bottom;"><div style="width:953px; margin:0 auto; z-index:1"><div style=" position:absolute; width:953px; margin-top:-278px;"><a href="#test"><img src="img/landing/banner.png" alt="" width="953" height="399" border="0" usemap="#Map" /></a></div></div></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    ...
    <table width="949" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="456" width="949" style="background:url(img/landing/bottom_back2.jpg);" valign="top">
    ...
    <img src="img/landing/bottom_sum.jpg"/>
     
        </td>
        
         <td style="padding-top:50px;padding-left:3px;"><img src="myclinicpal/img/sep.png" width="5" height="277"/></td>
        ...
        <a href="dentist_login.php"><img src="img/landing/dentist_access.png" width="283" height="95" /></a>
        
        </td></tr>
        
           <tr><td style="padding-top:10px;">
        
         <a href="patient/patient_login.php"><img src="img/landing/patient_access.png" width="283" height="95" /></a>
        
        </td></tr>
         <tr><td style="padding-top:10px;">
        
         <a href="#"><img src="img/landing/how.png" width="283" height="95" /></a>
