...
document.getElementById('price0').value=price;
...
//alert(total);
document.getElementById('tot0').value="P"+raw+".00";
document.getElementById('subtotal').value="P"+raw+".00";


var maverick = document.getElementById('subtotal').value;
maverick.charAt(0)=='P';
maverick=maverick.substr(1);
...
var tax = document.getElementById('taxnow').value;
tax.charAt(0)=='P';
tax=tax.substr(1);

var tax1 = tax;
 var tax2 = tax1.indexOf('.');
  tax1 = tax1.substring(0, tax2 != -1 ? tax2 : tax1.length);
  
tax1 = tax1.replace(/\,/g,'');
alert(tax1);
var put = parseInt(sgot) + parseInt(tax1);
...
document.getElementById('totaldue').value="P"+put+".00";
...
//end else in check if number or not
}
}
...
var eee = "check"+z;
var eve = "tot"+z;
var myli = document.getElementById(wew).value;
if(isNaN(myli)) {
alert('Please enter a valid number.');	
}
else {
...
g += '';
	...
	//return x1 + x2;
	var g =x1 + x2;
document.getElementById(wew).value=g;
 g = g.replace(/\,/g,'');
//alert(g);
...
//end if for check if not number
}
...
<td width="206" style="border-right:1px solid #cdcbd4;text-align:center;padding-top:10px;padding-bottom:10px;background-image:url(img/option_center_check.png);">Description</td>
<td width="169" style="border-right:1px solid #cdcbd4;text-align:center;padding-top:10px;padding-bottom:10px;background-image:url(img/option_center_check.png);">Date of transaction</td>
<td width="169" style="border-right:1px solid #cdcbd4;text-align:center;padding-top:10px;padding-bottom:10px;background-image:url(img/option_center_check.png);">Payment Due Date</td>
<td width="141" style="border-right:1px solid #cdcbd4;text-align:center;;padding-top:10px;padding-bottom:10px;background-image:url(img/option_center_check.png);">Price</td>
</tr>
...
<tr style="font-size:15px;font-weight:bold;background-color:<?php echo $back;?>;">
...
<tr><td style="width:200px;text-align:right;font-size:15px;">
Patient Name:
</td>
<td style="padding-left:10px;">
<select name="pt_name" id="pt_select" onchange="ChangeID(this.value)" tabindex="1" style="font-size:15px;">
...
<div style="clear:both;height:10px;"></div>
<table cellpadding="0" cellspacing="0" border="0" style="color:#333;font-weight:bold;;font-size:15px;font-family:Arial, Helvetica, sans-serif;padding-left:30px;">
<tr><td style="width:200px;text-align:right;font-size:15px;">Date of transaction:</td>
<td style="padding-left:10px;">
<table cellpadding="0" cellspacing="0" border="0">
<tr><td>
...
<input type="text" name="year" style="width:45px;font-size:15px;" value="<?php echo $y;?>"/>
</td></tr></table>
</td></tr>

<tr><td style="width:200px;text-align:right;padding-top:10px;font-size:15px;">Patient ID No:</td>
<td style="padding-left:10px;padding-top:10px;">

<input type="text" name="pt_id" id="pt_id" disabled="disabled" style="font-size:15px;"/>
...
<input type="text" name="transaction_id" id="transaction_id" disabled="disabled" value="<?php echo $draft_ids;?>" style="font-size:15px;"/>

</td></tr>

<tr><td style="width:200px;text-align:right;padding-top:10px;font-size:15px;">Payment Due:</td>
<td style="padding-left:10px;padding-top:10px;">
<table cellpadding="0" cellspacing="0" border="0">
...
<select name="due" onchange="ChangeSelect(this.value);" style="font-size:15px;">
...
<input type="text" name="others" style="width:60px;font-size:15px;" value="61"/>
</td>
...
<td width="195" style="text-align:left;padding-left:15px;">
Description
</td>
...
<tr><td>
<input type="checkbox" name="taxtotal" id="taxtotal" onclick="Showtax()" value="no" style="font-size:15px;"/></td>
...
<table cellspacing='0' cellpadding='0' border='0' width='620'><tr><td style="width:16px;"><img src='img/icon_address_delete.png' onclick='RemoveThis();'/></td><td style='padding-left:5px;width:60px;'><input type='text' name='unit[]' style="width:60px;font-size:15px;"></td><td style='padding-left:10px;width:20px;'><input type='text' name='qty[]' style='width:20px;font-size:15px;'  value='1' onchange="ChangeQty(0)" id='qty0'/></td><td style='padding-left:10px;width:250px;'>
<table cellpadding="0" cellspacing="0" border="0">
<tr><td><div style="clear:both;height:18px;"></div></td></tr>
<tr><td> 
<textarea name='desc[]' style="width:250px;height:35px;font-size:15px;font-family:Arial, Helvetica, sans-serif;"></textarea>
</td></tr></table>
</td><td style='padding-left:10px;width:20px;'><input type='checkbox' name='tax0' id='tax0' value="no" onchange="Multiply(0)" style="display:none;"/></td><td style='padding-left:10px;width:90px;'><input type='text' name='price[]' style='width:90px;text-align:right;font-size:15px;' value='0.00' id='price0' onchange="ChangePrice(0)" ></td><td style='padding-left:5px;width:80px;'><input type='text' style='border:none;width:80px;background-color:#FFF;text-align:right;font-size:15px;' id='tot0' name='total[]' value='P0.00' disabled="disabled"/></td></tr></table>
</div>
</div><!--end of table1-->
...
<input type="text" name="subtotal" id="subtotal" value="P0.00" style="border:none;width:80px;background-color:#FFF;text-align:right;font-size:15px;" disabled="disabled" />
</td>
</tr>
</table>
...
<td style="padding-left:5px;">
<input type="text" name="taxnow" id="taxnow" value="P0.00" style="font-size:15px;border:none;width:80px;background-color:#FFF;text-align:right;" disabled="disabled" />
</td>
</tr>
</table>
</td></tr>
...
<td style="padding-left:5px;">
<input type="text" name="totaldue" id="totaldue" value="P0.00" style="font-size:15px;border:none;width:80px;background-color:#FFF;text-align:right;" disabled="disabled" />
</td>
</tr>
</table>
...
function addInput(divName){
     if (counter==limit)  {
		  ...
		  newdiv.id = counter;
          newdiv.innerHTML = "<table cellspacing='0' cellpadding='0' border='0' width='620'><tr><td style='width:16px;'><img src='img/icon_address_delete.png' onclick='RemoveNow("+counter+")'/></td><td style='padding-left:5px;width:60px;'><input type='text' name='unit[]' style='width:60px;font-size:15px;'></td><td style='padding-left:10px;width:20px;'><input type='text' name='qty[]' onchange='changeqtynow("+counter+")' style='width:20px;font-size:15px;' value='1' id='qty"+counter+"'/></td><td style='padding-left:10px;width:250px;'><table cellpadding='0' cellspacing='0' border='0'><tr><td><div style='clear:both;height:18px;'></div></td></tr><tr><td><textarea name='desc[]' style='font-size:15px;width:250px;height:35px;font-family:Arial, Helvetica, sans-serif;'></textarea></td></tr></table></td><td style='padding-left:10px;width:20px;'><input type='checkbox' name='tax[]' id='check"+counter+"' onclick='Changetaxnow("+counter+")' style='display:none;font-size:15px;'/></td><td style='padding-left:10px;width:90px;'><input type='text' name='price[]' style='width:90px;text-align:right;font-size:15px;' value='0.00' id='price"+counter+"' onchange='Changetotalnow("+counter+")'></td><td style='padding-left:5px;width:80px;'><input type='text' style='font-size:15px;border:none;width:80px;background-color:#FFF;text-align:right;' id='tot"+counter+"' name='total[]' value='P0.00' disabled='disabled'/></td></tr></table>";
