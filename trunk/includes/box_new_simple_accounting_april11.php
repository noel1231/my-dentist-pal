...
</td><td style='padding-left:10px;width:20px;'><input type='checkbox' name='tax0' id='tax0' value="no" onchange="Multiply(0)" style="display:none;"/></td><td style='padding-left:10px;width:90px;'><input type='text' name='price[]' style='width:90px;text-align:right;font-size:15px;' value='0.00' id='price0' onchange="ChangePrice(0)" ></td><td style='padding-left:10px;width:60px;'><input type='text' style='border:none;width:60px;background-color:#FFF;text-align:right;font-size:15px;' id='tot0' name='total[]' value='P0.00' disabled="disabled"/></td></tr></table>
</div>
</div><!--end of table1-->
...
<td>
<input type="text" name="subtotal" id="subtotal" value="P0.00" style="border:none;width:60px;background-color:#FFF;text-align:right;font-size:15px;" disabled="disabled" />
</td>
</tr>
</table>
...
<td>
<input type="text" name="taxnow" id="taxnow" value="P0.00" style="font-size:15px;border:none;width:60px;background-color:#FFF;text-align:right;" disabled="disabled" />
</td>
</tr>
</table>
</td></tr>
...
<td>
<input type="text" name="totaldue" id="totaldue" value="P0.00" style="font-size:15px;border:none;width:60px;background-color:#FFF;text-align:right;" disabled="disabled" />
</td>
</tr>
</table>
