    ...
    <td><table width="739" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <!--<form actio="dentist_addressbook.php">-->
         <input type="button" name="back" value="BACK" onclick="window.location.href='message_contact.php'" class="submit" style="margin-right:15px;margin-top:-4px;"/>
        <!--</form>-->
     ...
     <input type="submit" name="search" value="SEARCH" class="submit" style="margin-right:17px;margin-top:-6px;" />--></td></tr></table>
      ...
      <tr>
        <td valign="top" style="background:url(img/3.jpg); padding-bottom:10px;"><div style="margin-top:-8px; position: relative;">
         ...
         <h2 style="color:#333;font-size:18px;">Edit Contact</h2>
         </td></tr>
         <tr><td style="padding-top:20px;">
         <form method="post" action="" enctype="multipart/form-data">
         <table cellpadding="0" cellspacing="0" border="0">
<tr><td style="font-size:14px;color:#333;width:200px;text-align:right;">
Last name</td> <td style="padding-left:20px;"><input type="text" name="last_name" value="<?php echo $row["last_name"];?>"/> 
</td></tr>
<tr><td style="font-size:14px;color:#333;width:200px;text-align:right;padding-top:15px;">
First name</td><td style="padding-left:20px;padding-top:15px;"><input type="text" name="first_name" value="<?php echo $row["first_name"];?>"/> 
</td></tr>
<tr><td style="font-size:14px;color:#333;width:200px;text-align:right;padding-top:15px;">
Address</td><td style="padding-left:20px;padding-top:15px;"><input type="text" name="address" value="<?php echo $row["address"];?>"/> 
</td></tr>
<tr><td style="font-size:14px;color:#333;width:200px;text-align:right;padding-top:15px;">
Email </td><td style="padding-left:20px;padding-top:15px;"><input type="text" name="email" value="<?php echo $row["email"];?>"/> 
</td></tr>
<tr><td style="font-size:14px;color:#333;width:200px;text-align:right;padding-top:15px;">
Contact Number</td><td style="padding-left:20px;padding-top:15px;"><input type="text" name="contact" value="<?php echo $row["contact_number"];?>"/> 
</td></tr>
<tr><td style="font-size:14px;color:#333;width:200px;text-align:right;padding-top:15px;">
Birthday</td><td style="padding-left:20px;padding-top:15px;"><input type="text" name="bday" id="datepicker" value="<?php echo $bday;?>"/> 
</td></tr>
<tr><td style="font-size:14px;color:#333;width:200px;text-align:right;padding-top:15px;">
Work</td><td style="padding-left:20px;padding-top:15px;"><input type="text" name="work" id="work" value="<?php echo $row['work'];?>"/> 
</td></tr>
<tr><td style="font-size:14px;color:#333;width:200px;text-align:right;padding-top:15px;">
Company</td><td style="padding-left:20px;padding-top:15px;"><input type="text" name="company" id="company" value="<?php echo $row['company'];?>"/> 
</td></tr>
<tr><td style="font-size:14px;color:#333;width:200px;text-align:right;padding-top:15px;">
Company Address</td><td style="padding-left:20px;padding-top:15px;"><input type="text" name="companyadd" id="companyadd" value="<?php echo $row['work_address'];?>"/> 
</td></tr>
<tr><td style="font-size:14px;color:#333;width:200px;text-align:right;padding-top:15px;">
Group</td><td style="padding-left:20px;padding-top:15px;"><select name="group">
