...
$sql="SELECT * FROM blogging";
$res=mysql_query($sql); }
while($row=mysql_fetch_array($res)) {
?>

<table cellpadding="0" cellspacing="0" border="0" style="padding-left:50px;padding-top:20px;">

<tr><td style="font-weight:bold;font-size:14px;"><a href="blog_view.php?id=<?php echo $row['id'];?>">
