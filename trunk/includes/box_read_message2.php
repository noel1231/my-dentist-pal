...
$sql="SELECT * FROM message_sent WHERE id=".$key."";
$res=mysql_query($sql);
            ...
            <?php
			  ...
			  while($row=mysql_fetch_array($res))
			  {
				...
				$pt_id=$row['patient_id'];
				  $sqls="SELECT * FROM dentist_list WHERE dentist_id='".$den_id."'";
		...
		//var_dump($count);die();
			 ...
			 { $sqls="SELECT * FROM patient_list WHERE id='".$pt_id."'";
			  ...
			  while($rows=mysql_fetch_array($ress)){
				...
				$sqls="SELECT * FROM addressbook WHERE id='".$pt_id."'"; 
				$ress=mysql_query($sqls);
				while($rows=mysql_fetch_array($ress)) {
        ...
        <td colspan="2" valign="top" style="background:url(img/3.jpg); padding-bottom:10px;"><div style="margin-top:-8px; position: relative;">
          <table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <!--I just want to inquire your availability--><?php echo $row["subject_message"];?>
              </td></tr>
              
              <tr><td style="font-weight:bold;color:#373838;font-size:14px;padding-top:10px;width:500px;">
              ...
              <td style="font-weight:bold;color:#373838;font-size:14px;padding-top:10px;width:150px;">
              Date: &nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#898989;"><?php echo $row["date_message"];?></span>
              </td>
              </tr>
              ...
              <tr><td width="100%">
              <?php echo stripslashes(nl2br($row["body_message"]));?>
              </td></tr>
              </table>
              </td>
              <!--middle--></tr>
              ...
              <!--separator-->
              <form method="post" action="reply2.php" enctype="multipart/form-data">
            ...
            <input type="submit" name="quick_reply" value="Quick Reply" class="submit2"/>&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="cancel" value="Cancel" class="submit2" onclick="javascript:history.go(-1)"/>
              ...
              <input type="hidden" name="subject" value="<?php echo $row["subject_message"];?>" />
               <!--</td>
            </tr>-->
            </table><!--</div>--></td></tr>
            </form>
