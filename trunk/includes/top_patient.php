...
<div style="margin:0 auto;width:960px; padding-right:20px;">
...
<span style="float:right;"><img src="images/topsep.png" style="margin-right:12px;"/></span>
<span style="float:right;"><img src="images/topname.png" style="margin-top:5px;"/><span style="font-family:Arial, Helvetica, sans-serif;font-size:12px;margin-left:3px;color:#d1e64b;"><div style="float:right;margin-top:6px;margin-right:15px;"><?php echo $fname." ".$lname;?></div></span></span>
</div>
</div>