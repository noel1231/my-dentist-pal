  ...
  header('Location: simple_accounting_list.php');
	...
	$date=$row['date_due'];
	  $dates=explode("-",$date);
              ...
              <?php echo "P".number_format($row['price']).".00";?>
              </td>
               <td style="padding-top:10px;padding-bottom:10px;text-align:right;padding-right:10px;border-right:1px solid #cdcbd4;">
	...
	{ $back="#e0eefa";}
              ...
              <tr style="font-size:15px;color:#333;background-color:<?php echo $back;?>;cursor:pointer;" onclick="window.location='simple_accounting_list.php?key=<?php echo $row['draft_id'];?>'">
...
?>
              ...
              <tr><td colspan="6"><hr /></td></tr>
              <tr><td colspan="6" align="right" style="padding-right:10px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;">
			  ...
			  echo "Total for open transaction:  <span style=\"color:#F00;\">P".number_format($ctr);echo ".00</span>";
			  ?>
             ...
             <!-- <tr><td colspan="6"><hr /></td></tr>-->
			  ...
			  echo "Total for closed transaction:  P".number_format($amt);echo ".00";
             ...
             <!-- <tr><td colspan="6"><hr /></td></tr>-->
              <tr><td colspan="6" align="right" style="padding-right:10px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;">Total: P<?php echo number_format($main_total);?>.00</td></tr>
              </table>
