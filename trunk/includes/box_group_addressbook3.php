...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr style="font-family:Arial, Helvetica, sans-serif;">
	...
	{ $back="#e0eefa";}
            ...
            <td style="padding-bottom:5px;padding-top:5px;border-bottom:1px solid #e5e3e3;text-align:center;">
          <input type="checkbox" name="check[]" id="check<?php echo $i;?>" value="<?php echo $row["id"];?>"/>
            </td>
            
            <td style="padding-bottom:5px;padding-top:5px;border-bottom:1px solid #e5e3e3;text-align:left;padding-left:10px;">
            <?php echo $gname;?>
            </td>
