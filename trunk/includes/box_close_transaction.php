...
$dentist_id=$_SESSION['id'];
  ...
  function pagination($query, $per_page = 10,$page = 1, $url = '?', $what = 'close'){        
  ...
  <tr>
          ...
          <table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
             ...
             <a href="dentist_simple_accounting.php" style="color:#333;text-decoration:none;"> Add Transactions
              ...
              <a href="transaction.php?id=close&amp;arr=draft_date" style="color:#333;text-decoration:underline;">Date</a>
              </td>
              <td style="width:50px;padding-top:10px;padding-bottom:10px;text-align:center;border-right:1px solid #cdcbd4;">
              <a href="transaction.php?id=close&amp;arr=draft_id" style="color:#333;text-decoration:underline;">ID</a></td>
              <td style="width:190px;padding-top:10px;padding-bottom:10px;text-align:center;border-right:1px solid #cdcbd4;">
              <a href="transaction.php?id=close&amp;arr=patient_name" style="color:#333;text-decoration:underline;">
              Patient Name</td>
	...
	{ $back="#e0eefa";}
			 ...
			 // var_dump($check);die();
			  ...
			  echo "open";
			   $total=$row['total'];
			  }  $ammount=$row['ammount_paid'];			   $total1=$total - $ammount;			  if ($total1==0){			  ?>
              </td>
              <td style="padding-top:10px;padding-bottom:10px;text-align:center;">
              <?php echo $month." ".$d.", ".$y;?>
              </td>
			 ...
			 /* if($check=="yes") {
			  ...
			  $main_total=$main_total+(str_replace("," , "" , $total));
			  ?>
              </td>
              </tr>
