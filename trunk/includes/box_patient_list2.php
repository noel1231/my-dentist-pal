...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
      ...
      <tr>
    	...
    	$startpoint = ($page * $limit) - $limit;
		 //$statement = "`records` where `active` = 1";
			 ...
			 { $query="SELECT * FROM patient_list WHERE dentist_id='".$dentist_id."' ORDER BY date_of_entry DESC LIMIT {$startpoint} , {$limit}";
			  $res=mysql_query($query); 
			  
			  $statement = "patient_list WHERE dentist_id='".$dentist_id."' ORDER BY date_of_entry DESC";
	...
	{ $back="#e0eefa";}
			  ...
			  ?>
              <tr>
              <!--check--><td width="58" style="padding-bottom:5px;padding-top:5px;border-bottom:1px solid #e5e3e3;">
              <input type="checkbox" name="check[]" style="margin-left:22px;" id="check<?php echo $i;?>" value="<?php echo $row["id"];?>"/>
              <!--check--></td>
              <!--name--><td style="width:210px;padding-bottom:5px;padding-top:5px;border-bottom:1px solid #e5e3e3;">
              ...
              <!--last visit--><td style="width:160px;text-align:center;padding-bottom:5px;padding-top:5px;border-bottom:1px solid #e5e3e3;">
              <div><?php echo $row['log_date'];?></div>
              <!--last visit--></td>
			  <!--last visit--><td style="width:154px;text-align:center;padding-bottom:5px;padding-top:5px;border-bottom:1px solid #e5e3e3;">
              <div><?php echo $reg;?></div>
              <!--last visit--></td>
              <!--action--><td width="108" style="padding-bottom:5px;padding-top:5px;border-bottom:1px solid #e5e3e3;">
             <table cellpadding="0" cellspacing="0" border="0">
             <tr>
             ...
             <!--delete--><td style="padding-left:9px;"><a href="patient_list.php?id=<?php echo $row["id"];?>" onclick="return onDelete();" title="Delete"><img src="img/icon_address_delete.png" height="15" width="15" /></a></td>
             </tr>
             </table>
              <!--action--></td>
              </tr>
