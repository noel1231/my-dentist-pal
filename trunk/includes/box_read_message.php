...
$idy = $_GET['id'];  
$yes="yes";
$sql="UPDATE message_received SET message_read='".$yes."' WHERE id='".$idy."'";
$res=mysql_query($sql);
$sql="SELECT * FROM message_received WHERE id=".$idy."";
$res=mysql_query($sql);
        ...
        <td colspan="2" valign="top" style="background:url(img/3.jpg); padding-bottom:10px;"><div style="margin-top:-8px; position: relative;">
          <table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <tr><td width="100%">
              <?php echo stripslashes(nl2br($row["message_content"]));?>
              </td></tr>
              </table>
              </td>
              <!--middle--></tr>
