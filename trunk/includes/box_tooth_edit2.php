...
$i=0;
if($what_chart==1) {
$sql="SELECT * FROM patient_tooth_chart_extra_adult WHERE patient_id='".$pt_ids."' ORDER BY date_chart DESC LIMIT 5";
$res=mysql_query($sql);
...
$sql="SELECT * FROM patient_tooth_chart_extra_child WHERE patient_id='".$pt_ids."' ORDER BY date_chart DESC LIMIT 5";	
$res=mysql_query($sql);
}
while($row=mysql_fetch_array($res)) {
...
<div style="float:left;margin-top:5px;margin-left:3px;"><textarea name="remarks" style="width:335px;height:137px;font-family:Arial, Helvetica, sans-serif;" disabled="disabled"><?php 
