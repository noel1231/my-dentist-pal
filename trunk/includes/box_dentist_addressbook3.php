...
if(isset($_POST['delete_all']))
{
		...
		if($_POST["check"][$i] != "") {
			$qwerty="DELETE FROM addressbook WHERE id='".$_POST['check'][$i]."'";
...
if(count($_POST["check"]) >= 2) {
	...
	header('Location: add_in_addressbook.php?id='.$id.'');
	}
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr style="font-family:Arial, Helvetica, sans-serif;">
          ...
          <div style="width:140px; margin-left:20px; margin-bottom:-2px; float:left;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="661" align="center" style="background: url(img/u3.jpg);"><!--<img src="img/t-contact.png" alt="" />--><a href="dentist_addressbook.php" class="tablink">Address Book List</a></td>
        ...
        <td valign="top" style="background:url(img/3.jpg); padding-bottom:10px;"><div style="margin-top:-8px; position: relative;">
          <table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              &nbsp;&nbsp;
              <input type="button" name="addnew" value="Add" class="submit2" onclick="window.location.href='add_in_addressbook.php?id=add'"/>&nbsp;&nbsp;
         <input class="submit2" type="submit" name="edit" value="Edit"/>
            ...
            <tr><td style="width:100px;height:30px;background-image:url(img/option_center_check.png);text-align:center;border-right:1px solid #d4d3db;">
           <input name="CheckAll" type="checkbox" id="CheckAll" value="Y"  onClick="ClickCheckAll(this);" />
            </td>
           
            <td style="width:260px;height:30px;background-image:url(img/option_name_repeat.png);text-align:center;border-right:1px solid #d4d3db;">
            <span style="color:#333;font-size:13px;font-weight:bold;"><a href="dentist_addressbook.php?arr=last_name" style="text-decoration:underline;color:#333;" title="Sort by Name">Name</a></span>
            </td>
            ...
            <span style="color:#333;font-size:13px;font-weight:bold;"><a href="dentist_addressbook.php?arr=group_name" style="text-decoration:underline;color:#333;" title="Sort by Group">Group</a></span>
            </td>
            ...
            <span style="color:#333;font-size:13px;font-weight:bold;"><a href="dentist_addressbook.php?arr=email" style="text-decoration:underline;color:#333;" title="Sort by Email">Email Address</a></span>
            </td>
          ...
          if(isset($_GET['arr']))
			   ...
			   $query="SELECT * FROM addressbook WHERE dentist_id='".$dentist_id."' ORDER by $sort $arrange";
	...
	{ $back="#e0eefa";}
            ...
            <td style="padding-top:5px;padding-bottom:5px;text-align:center;border-bottom:1px solid #e5e3e3;">
          <input type="checkbox" name="check[]" id="check<?php echo $i;?>" value="<?php echo $row["id"];?>"/>
            </td>
            
            <td style="padding-top:5px;padding-bottom:5px;text-align:left;padding-left:10px;border-bottom:1px solid #e5e3e3;">
            ...
            <td style="padding-top:5px;padding-bottom:5px;border-bottom:1px solid #e5e3e3;">
            <table cellpadding="0" cellspacing="0" border="0">
            <tr>
