        ...
        <td valign="top" style="background:url(img/3.jpg); padding-bottom:10px;"><div style="margin-top:-8px; position: relative;">
          <table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <input type="text" name="email1" style="margin-left:10px;" id="validate"/><span id="validEmail"></span></td></tr></table>
              </td>
              </tr>
              <tr>
              <td style="padding-top:10px;padding-left:30px;">
              ...
              <input type="text" name="email2" style="margin-left:10px;" id="validates"/><span id="validEmails"></span></td></tr></table>
              </td>
              </tr>
