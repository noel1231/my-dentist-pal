  ...
  <tr>
        ...
        <td colspan="2" valign="top" style="background:url(img/3.jpg); padding-bottom:10px;"><div style="margin-top:-8px; position: relative;">
          <table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <div style="float:left;background-image:url(img/option_name_repeat.png);width:241px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;">Name</div>
              <div style="float:left;background-image:url(img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--name holder-->
              ...
              <!--subject holder-->
              <div style="float:left;">
              <div style="float:left;background-image:url(img/option_name_repeat.png);width:226px;height:26px;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:bold;color:#373838;padding-top:10px;padding-left:17px;">Group</div>
              <div style="float:left;background-image:url(img/option_right_check.png);width:5px;height:36px;"></div>
              </div>
              <!--subject holder-->
    	...
    	$startpoint = ($page * $limit) - $limit;
		 //$statement = "`records` where `active` = 1";
			  ...
			  if(isset($_POST['apply']))
			   ...
			   $query="SELECT * FROM addressbook WHERE dentist_id='".$dentist_id."' ORDER by $sort ASC LIMIT {$startpoint} , {$limit}";
			   $res=mysql_query($query);
			   
			    $statement = "addressbook WHERE dentist_id='".$dentist_id."' ORDER by $sort ASC";
	...
	$fname=$row["first_name"];
			$lname=$row["last_name"];
              ...
              <!--check--></td>
              <!--name--><td style="width:263px;padding-left:20px;padding-top:10px;padding-bottom:10px;text-align:left;" >
             <a href="message_compose.php?id=<?php echo $row["id"];?>" style="text-decoration:none;color:#373838;">
             <div><!--Maverick Bersabe--><?php echo $fname." ".$lname;?></div>
             </a>
              <!--name--></td>
                <!--subject<td style="width:165px;">
              <div style="margin-top:10px;margin-left:18px;">Good Morning</div>
              subject</td>-->
              <!--last visit--><td style="width:248px;padding-left:20px;padding-top:10px;padding-bottom:10px;text-align: left;">
              <div style="color:#373838;"><?php echo $row["group_name"];?></div>
              <!--last visit--></td>
              <!--action--><td width="119" style="padding-top:10px;padding-bottom:10px;">
             <table cellpadding="0" cellspacing="0" border="0">
             <tr>
