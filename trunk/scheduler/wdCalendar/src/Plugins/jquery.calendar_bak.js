...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        var __SCOLLEVENTTEMP = "<DIV style=\"WIDTH:${width};top:${top};left:${left};\" title=\"${title}\" class=\"chip chip${i} ${drag}\"><div class=\"dhdV\" style=\"display:none\">${data}</div><DIV style=\"BORDER-BOTTOM-COLOR:#0281aa;\" class=ct>&nbsp;</DIV><DL style=\"BORDER-BOTTOM-COLOR:#0281aa; BACKGROUND-COLOR:#0281aa; BORDER-TOP-COLOR: #0281aa; HEIGHT: ${height}px; BORDER-RIGHT-COLOR:#0281aa; BORDER-LEFT-COLOR:#0281aa\"><DT style=\"BACKGROUND-COLOR:#0281aa;\">${starttime} - ${endtime} ${icon}</DT><DD><SPAN>${content}</SPAN></DD><DIV class='resizer' style='display:${redisplay}'><DIV class=rszr_icon>&nbsp;</DIV></DIV></DL><DIV style=\"BORDER-BOTTOM-COLOR:#0281aa; BACKGROUND-COLOR:#0281aa; BORDER-TOP-COLOR: #0281aa; BORDER-RIGHT-COLOR: #0281aa; BORDER-LEFT-COLOR:#0281aa;\" class=cb1>&nbsp;</DIV><DIV style=\"BORDER-BOTTOM-COLOR:#0281aa; BORDER-TOP-COLOR:#0281aa; BORDER-RIGHT-COLOR:#0281aa; BORDER-LEFT-COLOR:#0281aa;\" class=cb2>&nbsp;</DIV></DIV>";
        var __ALLDAYEVENTTEMP = '<div class="rb-o ${eclass}" id="${id}" title="${title}" style="color:${color};"><div class="dhdV" style="display:none">${data}</div><div class="${extendClass} rb-m" style="background-color:#0281aa;">${extendHTML}<div class="rb-i">${content}</div></div></div>';
