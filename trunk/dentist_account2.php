...
<div style="float:left;margin-left:10px;margin-top:20px;width:210px;" ><a href="dentist_landing.php" style="font-family:Arial, Helvetica, sans-serif;font-size:32px;color:#FFF;text-decoration:none;" title="Go to Dashboard">My Dentist Pal</a></div>
<div onclick="window.location='dentist_landing.php'" style="float:left;margin-left:5px;margin-top:23px;font-size:12px;color:#70d8f8;font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;">Ver. 1.0</div>
</div><!--end of left-->
<!--right-->
...
<?php
	include('includes/box_dentist_account2.php'); 
 ?>
<!--content--></td>
</tr>
