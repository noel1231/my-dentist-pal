...
<?php include('includes/tooth/table_child_tooth.php');?>
...
<img src="img/Toothchart/01.png" onclick="popup('popUpDiv','child1','childs1','legs_11','le55')" name="child1" id="child1" value="none" /> 

<?php } else if($tooth_1<=9) { ?>

<img src="img/Toothchart/0<?php echo $tooth_1;?>.png" onclick="popup('popUpDiv','child1','childs1','legs_11','le55')" name="child1" id="child1" value="none" />

<?php } else { ?>

<img src="img/Toothchart/<?php echo $tooth_1;?>.png" onclick="popup('popUpDiv','child1','childs1','legs_11','le55')" name="child1" id="child1" value="none" />
...
<img src="img/Toothchart/01.png" onclick="popup('popUpDiv','child2','childs2','legs_12','le54')" name="child2" id="child2" value="none" /> 

<?php } else if($tooth_2<=9) { ?>

<img src="img/Toothchart/0<?php echo $tooth_2;?>.png" onclick="popup('popUpDiv','child2','childs2','legs_12','le54')" name="child2" id="child2" value="none" />

<?php } else { ?>

<img src="img/Toothchart/<?php echo $tooth_2;?>.png" onclick="popup('popUpDiv','child2','childs2','legs_12','le54')" name="child2" id="child2" value="none" />
...
<img src="img/Toothchart/01.png" onclick="popup('popUpDiv','child3','childs3','legs_13','le53')" name="child3" id="child3" value="none" /> 

<?php } else if($tooth_3<=9) { ?>

<img src="img/Toothchart/0<?php echo $tooth_3;?>.png" onclick="popup('popUpDiv','child3','childs3','legs_13','le53')" name="child3" id="child3" value="none" />

<?php } else { ?>

<img src="img/Toothchart/<?php echo $tooth_3;?>.png" onclick="popup('popUpDiv','child3','childs3','legs_13','le53')" name="child3" id="child3" value="none" />
...
<img src="img/Toothchart/01.png" onclick="popup('popUpDiv','child4','childs4','legs_14','le52')" name="child4" id="child4" value="none" /> 

<?php } else if($tooth_4<=9) { ?>

<img src="img/Toothchart/0<?php echo $tooth_4;?>.png" onclick="popup('popUpDiv','child4','childs4','legs_14','le52')" name="child4" id="child4" value="none" />

<?php } else { ?>

<img src="img/Toothchart/<?php echo $tooth_4;?>.png" onclick="popup('popUpDiv','child4','childs4','legs_14','le52')" name="child4" id="child4" value="none" />
...
<img src="img/Toothchart/01.png" onclick="popup('popUpDiv','child5','childs5','legs_15','le51')" name="child5" id="child5" value="none" /> 

<?php } else if($tooth_5<=9) { ?>

<img src="img/Toothchart/0<?php echo $tooth_5;?>.png" onclick="popup('popUpDiv','child5','childs5','legs_15','le51')" name="child5" id="child5" value="none" />

<?php } else { ?>

<img src="img/Toothchart/<?php echo $tooth_5;?>.png" onclick="popup('popUpDiv','child5','childs5','legs_15','le51')" name="child5" id="child5" value="none" />
...
<img src="img/Toothchart/01.png" onclick="popup('popUpDiv','child6','childs9','legs_16','le61')" name="child6" id="child6" value="none" /> 

<?php } else if($tooth_6<=9) { ?>

<img src="img/Toothchart/0<?php echo $tooth_6;?>.png" onclick="popup('popUpDiv','child6','childs9','legs_16','le61')" name="child6" id="child6" value="none" />

<?php } else { ?>

<img src="img/Toothchart/<?php echo $tooth_6;?>.png" onclick="popup('popUpDiv','child6','childs9','legs_16','le61')" name="child6" id="child6" value="none" />
...
<img src="img/Toothchart/01.png" onclick="popup('popUpDiv','child7','childs10','legs_17','le62')" name="child7" id="child7" value="none" /> 

<?php } else if($tooth_7<=9) { ?>

<img src="img/Toothchart/0<?php echo $tooth_7;?>.png" onclick="popup('popUpDiv','child7','childs10','legs_17','le62')" name="child7" id="child7" value="none" />

<?php } else { ?>

<img src="img/Toothchart/<?php echo $tooth_7;?>.png" onclick="popup('popUpDiv','child7','childs10','legs_17','le62')" name="child7" id="child7" value="none" />
...
<img src="img/Toothchart/01.png" onclick="popup('popUpDiv','child8','childs11','legs_18','le63')" name="child8" id="child8" value="none" /> 

<?php } else if($tooth_8<=9) { ?>

<img src="img/Toothchart/0<?php echo $tooth_8;?>.png" onclick="popup('popUpDiv','child8','childs11','legs_18','le63')" name="child8" id="child8" value="none" />

<?php } else { ?>

<img src="img/Toothchart/<?php echo $tooth_8;?>.png" onclick="popup('popUpDiv','child8','childs11','legs_18','le63')" name="child8" id="child8" value="none" />
...
<img src="img/Toothchart/01.png" onclick="popup('popUpDiv','child9','childs12','legs_19','le64')" name="child9" id="child9" value="none" /> 

<?php } else if($tooth_9<=9) { ?>

<img src="img/Toothchart/0<?php echo $tooth_9;?>.png" onclick="popup('popUpDiv','child9','childs12','legs_19','le64')" name="child9" id="child9" value="none" />

<?php } else { ?>

<img src="img/Toothchart/<?php echo $tooth_9;?>.png" onclick="popup('popUpDiv','child9','childs12','legs_19','le64')" name="child9" id="child9" value="none" />
...
<img src="img/Toothchart/01.png" onclick="popup('popUpDiv','child10','childs13','legs_20','le65')" name="child10" id="child10" value="none" /> 

<?php } else if($tooth_10<=9) { ?>

<img src="img/Toothchart/0<?php echo $tooth_10;?>.png" onclick="popup('popUpDiv','child10','childs13','legs_20','le65')" name="child10" id="child10" value="none" />

<?php } else { ?>

<img src="img/Toothchart/<?php echo $tooth_10;?>.png" onclick="popup('popUpDiv','child10','childs13','legs_20','le65')" name="child10" id="child10" value="none" />
...
<img src="img/Toothchart/01.png" onclick="popup('popUpDiv','child11','childs17','legs_21','le85')" name="child11" id="child11" value="none" /> 

<?php } else if($tooth_11<=9) { ?>

<img src="img/Toothchart/0<?php echo $tooth_11;?>.png" onclick="popup('popUpDiv','child11','childs17','legs_21','le85')" name="child11" id="child11" value="none" />

<?php } else { ?>

<img src="img/Toothchart/<?php echo $tooth_11;?>.png" onclick="popup('popUpDiv','child11','childs17','legs_21','le85')" name="child11" id="child11" value="none" />
...
<img src="img/Toothchart/01.png" onclick="popup('popUpDiv','child12','childs18','legs_22','le84')" name="child12" id="child12" value="none" /> 

<?php } else if($tooth_12<=9) { ?>

<img src="img/Toothchart/0<?php echo $tooth_12;?>.png" onclick="popup('popUpDiv','child12','childs18','legs_22','le84')" name="child12" id="child12" value="none" />

<?php } else { ?>

<img src="img/Toothchart/<?php echo $tooth_12;?>.png" onclick="popup('popUpDiv','child12','childs18','legs_22','le84')" name="child12" id="child12" value="none" />
...
<img src="img/Toothchart/01.png" onclick="popup('popUpDiv','child13','childs19','legs_23','le83')" name="child13" id="child13" value="none" /> 

<?php } else if($tooth_13<=9) { ?>

<img src="img/Toothchart/0<?php echo $tooth_13;?>.png" onclick="popup('popUpDiv','child13','childs19','legs_23','le83')" name="child13" id="child13" value="none" />

<?php } else { ?>

<img src="img/Toothchart/<?php echo $tooth_13;?>.png" onclick="popup('popUpDiv','child13','childs19','legs_23','le83')" name="child13" id="child13" value="none" />
...
<img src="img/Toothchart/01.png" onclick="popup('popUpDiv','child14','childs20','legs_24','le82')" name="child14" id="child14" value="none" /> 

<?php } else if($tooth_14<=9) { ?>

<img src="img/Toothchart/0<?php echo $tooth_14;?>.png" onclick="popup('popUpDiv','child14','childs20','legs_24','le82')" name="child14" id="child14" value="none" />

<?php } else { ?>

<img src="img/Toothchart/<?php echo $tooth_14;?>.png" onclick="popup('popUpDiv','child14','childs20','legs_24','le82')" name="child14" id="child14" value="none" />
...
<img src="img/Toothchart/01.png" onclick="popup('popUpDiv','child15','childs21','legs_25','le81')" name="child15" id="child15" value="none" /> 

<?php } else if($tooth_15<=9) { ?>

<img src="img/Toothchart/0<?php echo $tooth_15;?>.png" onclick="popup('popUpDiv','child15','childs21','legs_25','le81')" name="child15" id="child15" value="none" />

<?php } else { ?>

<img src="img/Toothchart/<?php echo $tooth_15;?>.png" onclick="popup('popUpDiv','child15','childs21','legs_25','le81')" name="child15" id="child15" value="none" />
...
<img src="img/Toothchart/01.png" onclick="popup('popUpDiv','child16','childs25','legs_26','le71')" name="child16" id="child16" value="none" /> 

<?php } else if($tooth_16<=9) { ?>

<img src="img/Toothchart/0<?php echo $tooth_16;?>.png" onclick="popup('popUpDiv','child16','childs25','legs_26','le71')" name="child16" id="child16" value="none" />

<?php } else { ?>

<img src="img/Toothchart/<?php echo $tooth_16;?>.png" onclick="popup('popUpDiv','child16','childs25','legs_26','le71')" name="child16" id="child16" value="none" />
...
<img src="img/Toothchart/01.png" onclick="popup('popUpDiv','child17','childs26','legs_27','le72')" name="child17" id="child17" value="none" /> 

<?php } else if($tooth_17<=9) { ?>

<img src="img/Toothchart/0<?php echo $tooth_17;?>.png" onclick="popup('popUpDiv','child17','childs26','legs_27','le72')" name="child17" id="child17" value="none" />

<?php } else { ?>

<img src="img/Toothchart/<?php echo $tooth_17;?>.png" onclick="popup('popUpDiv','child17','childs26','legs_27','le72')" name="child17" id="child17" value="none" />
...
<img src="img/Toothchart/01.png" onclick="popup('popUpDiv','child18','childs27','legs_28','le73')" name="child18" id="child18" value="none" /> 

<?php } else if($tooth_18<=9) { ?>

<img src="img/Toothchart/0<?php echo $tooth_18;?>.png" onclick="popup('popUpDiv','child18','childs27','legs_28','le73')" name="child18" id="child18" value="none" />

<?php } else { ?>

<img src="img/Toothchart/<?php echo $tooth_18;?>.png" onclick="popup('popUpDiv','child18','childs27','legs_28','le73')" name="child18" id="child18" value="none" />
...
<img src="img/Toothchart/01.png" onclick="popup('popUpDiv','child19','childs28','legs_29','le74')" name="child19" id="child19" value="none" /> 

<?php } else if($tooth_19<=9) { ?>

<img src="img/Toothchart/0<?php echo $tooth_19;?>.png" onclick="popup('popUpDiv','child19','childs28','legs_29','le74')" name="child19" id="child19" value="none" />

<?php } else { ?>

<img src="img/Toothchart/<?php echo $tooth_19;?>.png" onclick="popup('popUpDiv','child19','childs28','legs_29','le74')" name="child19" id="child19" value="none" />
...
<img src="img/Toothchart/01.png" onclick="popup('popUpDiv','child20','childs29','legs_30','le75')" name="child20" id="child20" value="none" /> 

<?php } else if($tooth_20<=9) { ?>

<img src="img/Toothchart/0<?php echo $tooth_20;?>.png" onclick="popup('popUpDiv','child20','childs29','legs_30','le75')" name="child20" id="child20" value="none" />

<?php } else { ?>

<img src="img/Toothchart/<?php echo $tooth_20;?>.png" onclick="popup('popUpDiv','child20','childs29','legs_30','le75')" name="child20" id="child20" value="none" />
