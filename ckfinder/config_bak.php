...
$id=$_SESSION["id"];
	...
	$baseUrl = 'http://mydenitistpal.com/ckfinder/userfiles/images/'.$id.'/';
...
$Dir="/home/mydentis/public_html/ckfinder/userfiles/images/".$id;
//var_dump($acctId);die();
if ("/home/mydentis/public_html/ckfinder/userfiles/images/".$id)
{ $baseDir= "/home/mydentis/public_html/ckfinder/userfiles/images/".$id; 
//echo "yes";
}
else
{ mkdir("/home/mydentis/public_html/ckfinder/userfiles/images/".$id); 
$baseDir= "/home/mydentis/public_html/ckfinder/userfiles/images/".$id;
//echo "no";
} 
