...
<tr><td style="padding-top:5px;"><input type="password" name="pass1" style="width:378px;font-size:16px;" /></td></tr>
...
<tr><td style="padding-top:5px;"><input type="password" name="pass2" style="width:378px;font-size:16px;" /></td></tr>
...
?>
<td >
<a href="dentist_login" style="text-decoration:underline;color:#106dc6;font-size:14px;">
<?php
echo $return; ?></a>
</td>
...
<td style="padding-left:15px;">
<input type="button" name="cancel" value="CANCEL" class="submit2" onclick="window.location='dentist_login'"/>
</td>
</tr>
</table>
